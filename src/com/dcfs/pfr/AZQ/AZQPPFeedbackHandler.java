 ...
 * @Description: 爱之桥报告翻译
 * @Company: 21softech
 * @Created on 2014-10-13 下午5:07:56
 * @author xugy
...
public class AZQPPFeedbackHandler extends BaseHandler {
    ...
    public DataList findAZQPPFeedbackTransList(Connection conn, Data data, int pageSize, int page, String compositor, String ordertype) throws DBException {
      //查询条件
        ...
        String DISTRIB_DATE_START = data.getString("DISTRIB_DATE_START", null);   //开始分发日期
        String DISTRIB_DATE_END = data.getString("DISTRIB_DATE_END", null);   //结束分发日期
     ...
     * 
     * @Title: getFBREDID
     * @Description: 翻译数据对应的报告记录
     * @author: xugy
     * @date: 2014-10-23下午6:12:10
     * @param conn
     * @param fB_T_ID
     * @return
     * @throws DBException 

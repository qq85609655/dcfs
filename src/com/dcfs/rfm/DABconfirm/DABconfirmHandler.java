...
public class DABconfirmHandler extends BaseHandler {
	
	/**
	 * <p>Title: </p> 
	 * <p>Description: </p>
	 */
	public DABconfirmHandler(){
	 ...
	 * @throws 
	 */
	public DataList DABconfirmList(Connection conn, Data data, int pageSize,
		...
		String PERSON_NAME = data.getString("PERSON_NAME", null);	//确认人
		...
		String sql = getSql("DABconfirmList", MALE_NAME, FEMALE_NAME, FILE_NO, REGISTER_DATE_START, REGISTER_DATE_END, APPLE_TYPE, PERSON_NAME, RETREAT_DATE_START, RETREAT_DATE_END, RETURN_STATE, COUNTRY_CODE, ADOPT_ORG_ID, compositor, ordertype, orgcode);
	 ...
	 * @return boolean    返回类型 
	 */
	public boolean DABconfirmSave(Connection conn, Map<String, Object> data, Map<String, Object> fileData)
            throws DBException {
		//***保存文件信息表*****

...
public class BGSconfirmHandler extends BaseHandler {
	
	/**
	 * <p>Title: </p> 
	 * <p>Description: </p>
	 */
	public BGSconfirmHandler(){
	 ...
	 * @throws 
	 */
	public DataList BGSconfirmList(Connection conn, Data data, int pageSize,
		...
		String sql = getSql("BGSconfirmList", MALE_NAME, FEMALE_NAME, FILE_NO, REGISTER_DATE_START, REGISTER_DATE_END, APPLE_DATE_START, APPLE_DATE_END, FILE_TYPE, RETREAT_DATE_START, RETREAT_DATE_END, RETURN_STATE, HANDLE_TYPE, COUNTRY_CODE, ADOPT_ORG_ID, compositor, ordertype, orgcode);

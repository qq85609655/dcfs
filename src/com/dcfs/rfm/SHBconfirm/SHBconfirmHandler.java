...
public class SHBconfirmHandler extends BaseHandler {
	
	/**
	 * <p>Title: </p> 
	 * <p>Description: </p>
	 */
	public SHBconfirmHandler(){
	 ...
	 * @throws 
	 */
	public DataList SHBconfirmList(Connection conn, Data data, int pageSize,
		...
		String sql = getSql("SHBconfirmList", MALE_NAME, FEMALE_NAME, FILE_NO, REGISTER_DATE_START, REGISTER_DATE_END, APPLE_DATE_START, APPLE_DATE_END, FILE_TYPE, RETREAT_DATE_START, RETREAT_DATE_END, RETURN_STATE, HANDLE_TYPE, COUNTRY_CODE, ADOPT_ORG_ID, compositor, ordertype, orgcode);
	 ...
	 * @return boolean    返回类型 
	 */
	public boolean SHBconfirmSave(Connection conn, Map<String, Object> data, Map<String, Object> fileData)
            throws DBException {
		//***保存文件信息表*****

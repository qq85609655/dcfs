...
public class PDFUtil {
	...
	public static String readPDF(File file) {
		...
		try {
			...
			System.out.println("读取PDF文件" + file.getAbsolutePath() + "时失败！" + e);
			e.printStackTrace();
		} finally {
			if (in != null) {
				try {

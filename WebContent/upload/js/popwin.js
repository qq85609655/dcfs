...
function getFileUploadJson(){
	var jn = window.frames[iframefle].document.getElementById("JSON_STR").value;
	return jn;
}
...
popWinClose:function(){
            $("#mask,#maskTop").fadeOut(function() {
                $(this).remove();
            });
	},
showWin: function(width, height, title,type,src) {
        ...
        inntHtml += '</div>'
		inntHtml += document.getElementById(src).innerHTML;
		}else if(type =="iframe"){
        inntHtml += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:1999;background:#cccccc; filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity:0.5;"></div>'
        inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: fixed; top: 50%; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;">'
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; font-family: Microsoft Yahei; font-size: 20px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        ...
        inntHtml += '<div id="popWinClose" style="width: 28px; height: 28px; cursor: pointer; position: absolute; top: -12px; right: -9px; background-image: url(data:image/png;base64,);"></div>'
        inntHtml += '</div>'
        inntHtml += '<iframe id="showiframe" name ="showiframe" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';
        }
        $("body").append(inntHtml);
        this.int();
    },
showWinIframe: function(width, height,framename,title,type,src,y) {
        var iframeHeight = height - 52;
        var marginLeft = width / 2;
        var marginTop = height / 2;
        var inntHtml = '';
        ...
        inntHtml += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:1999;background:#cccccc; filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity:0.5;"></div>'
        inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: fixed; top: '+divHeight+'; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;">'
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; font-family: Microsoft Yahei; font-size: 20px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
        inntHtml += '<div id="popWinCloseFrame" style="width: 28px; height: 28px; cursor: pointer; position: absolute; top: -12px; right: -9px; background-image: url(data:image/png;base64,);"></div>'
        inntHtml += '</div>'
        inntHtml += '<iframe id="'+framename+'" name ="'+framename+'" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';
        }
		 iframefle = framename;
        $("body").append(inntHtml);
        this.int();
   ...
   mouseClose: function() {
        ...
        $("#popWinCloseFrame").on('mouseenter', 
        function() {
            $(this).css("background-image", "url(data:image/png;base64,)");

        });

        $("#popWinCloseFrame").on('mouseleave', 
        function() {
            $(this).css("background-image", "url(data:image/png;base64,)");
   ...
   closeMask: function() {
        ...
        $("#popWinCloseFrame").on('click', 
        function() {
            $("#mask,#maskTop").fadeOut(function() {
                $(this).remove();
            });
            var jn = getFileUploadJson();
            getIframeVal(jn);
        });
    }
};
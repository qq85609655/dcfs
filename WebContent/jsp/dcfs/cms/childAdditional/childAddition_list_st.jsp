...
<%
	/**   
	 * @Title: childAddition_list_st.jsp
	 * @Description:  儿童材料补充列表(省)
	 * @author furx   
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"cms/childaddition/findListST.action?page=1";
		...
		function _childAdd(){
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"cms/childaddition/getModifyData.action?UUID="+CA_ID+"&signal=2";
				document.srcForm.submit();
			}
		}
		//福利院儿童材料补充列表导出
	...
	<BZ:body property="data" codeNames="ETXB;BCZL;CHILD_TYPE;">
		<BZ:form name="srcForm" method="post" action="cms/childaddition/findListST.action">
			...
			<div class="wrapper">
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List"  exportXls="true" exportTitle="儿童补充材料" exportCode="SEX=CODE,ETXB;BIRTHDAY=DATE;CHILD_TYPE=CODE,CHILD_TYPE;SN_TYPE=CODE,BCZL;NOTICE_DATE=DATE;SOURCE=FLAG,2:省厅&3:中心;FEEDBACK_DATE=DATE;CA_STATUS=FLAG,0:待补充&1:补充中&2:已补充;" exportField="WELFARE_NAME_CN=福利院,18,20;NAME=姓名,15;SEX=性别,15;BIRTHDAY=出生日期,15;CHILD_TYPE=儿童类型,15;SN_TYPE=病残种类,15;NOTICE_DATE=通知日期,15;SOURCE=来源,15;FEEDBACK_DATE=反馈日期,15;CA_STATUS=补充状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

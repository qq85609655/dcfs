...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"cms/childupdate/updateListFLY.action?page=1";
		...
		function _modify(){
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"cms/childupdate/toModify.action?"+"CUI_ID="+CUI_ID+"&CI_ID="+CI_ID+"&UPDATE_TYPE=1";
				document.srcForm.submit();
			}
		}
		//查看补充材料详细信息
		...
		function _childUpdate(){
			var url = path + "cms/childupdate/updateSelectFLY.action";
		...
		function _toUpdate(CI_ID){
			document.srcForm.action=path+"cms/childupdate/toUpdateFLY.action?CI_ID="+CI_ID+"&UPDATE_TYPE=1";
			document.srcForm.submit();
		}
	</script>
	<BZ:body property="data" codeNames="ETXB;BCZL;CHILD_TYPE;UPDATE_STATE;">
		<BZ:form name="srcForm" method="post" action="cms/childupdate/updateListFLY.action">
			...
			<div class="wrapper">
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List"  exportXls="true" exportTitle="儿童材料更新" exportCode="SEX=CODE,ETXB;BIRTHDAY=DATE;CHILD_TYPE=CODE,CHILD_TYPE;SN_TYPE=CODE,BCZL;CHECKUP_DATE=DATE;UPDATE_DATE=DATE;UPDATE_STATE=CODE,UPDATE_STATE;" exportField="NAME=姓名,15,20;SEX=性别,15;BIRTHDAY=出生日期,15;CHILD_TYPE=儿童类型,15;SN_TYPE=病残种类,20;CHECKUP_DATE=体检日期,15;UPDATE_DATE=申请日期,15;UPDATE_STATE=更新状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

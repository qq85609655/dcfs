			   ...
			   <%
			       ...
			       <% for(int i=0;i<updateList.size();i++ ){
					   ...
					   <table class="specialtable" align="center" style='width:100%;text-align:center'>
			        	 <tr>
					        <td class="edit-data-title" style="text-align: left;"><%= (i+1)%>、更新日期：<%= tempDate%></td>
				         </tr>
			           </table>
	                    ...
	                    <table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
							...
							%>
							 <tr>
								<td><BZ:data field="UPDATE_FIELD" defaultValue="" onlyValue="true" isShowEN="true" codeName="TXGXXM" /></td>
								<%if("SN_TYPE".equals(updateField)){ %>
								<td><BZ:data field="ORIGINAL_DATA"  codeName="BCZL" isShowEN="true" defaultValue="" onlyValue="true"/></td>
								<td><BZ:data field="UPDATE_DATA"  codeName="BCZL" isShowEN="true" defaultValue="" onlyValue="true"/></td>
								<%}else if("IS_ANNOUNCEMENT".equals(updateField)||"IS_PLAN".equals(updateField)||"IS_HOPE".equals(updateField)){ %>
								<td><BZ:data field="ORIGINAL_DATA"  checkValue="0=no;1=yes;" defaultValue="" onlyValue="true"/></td>
								<td><BZ:data field="UPDATE_DATA"  checkValue="0=no;1=yes;" defaultValue="" onlyValue="true"/></td>
								<%}else{%>
								...
								<tr>
									...
									<%if(!"".equals(oldData)){
									      ...
									      for(int k=0;k<attOIds.length;k++){ 
									        ...
									        String attNameO=(attOIds[k].split("#"))[1];
									        int index=attNameO.lastIndexOf(".");
									        String fileType=attNameO.substring(index);
									        String attName=attId.substring(0,7)+fileType;%>
									        <a href="<up:attDownload attId='<%=attId%>' attTypeCode='CI'/> "><img src="<%=path%>/uploadComponent/view/images/att_sign.png"><font><%=attName%></font></a> <br/>
										<%}
								      }%>
								    </td>
									<td>
									<%if(!"".equals(newData)){
									      ...
									      for(int k=0;k<attIds.length;k++){ 
									        ...
									        String attNameO=(attIds[k].split("#"))[1];
									        int index=attNameO.lastIndexOf(".");
									        String fileType=attNameO.substring(index);
									        String attName=attId.substring(0,7)+fileType;%>
									        <a href="<up:attDownload attId='<%=attId%>' attTypeCode='CI'/> " ><img src="<%=path%>/uploadComponent/view/images/att_sign.png"><font><%=attName%></font></a> <br/>

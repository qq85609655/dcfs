...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"cms/childupdate/updateSelectST.action?page=1";
	...
	<BZ:body property="data" codeNames="ETXB;BCZL;CHILD_TYPE;ETZT_ST;">
		<BZ:form name="srcForm" method="post" action="cms/childupdate/updateSelectST.action">
					...
					<td style="width: 100%;">
						<table>
							...
							<tr>	
								...
								<td colspan="3">
								    <BZ:select prefix="S_" field="SN_TYPE" id="S_SN_TYPE" isCode="true" codeName="BCZL" formTitle="病残种类" defaultValue="" width="50%">
										<BZ:option value="">--请选择--</BZ:option>
									</BZ:select>
								</td>

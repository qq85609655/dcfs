...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"cms/childreturn/returnSelectFLY.action?page=1";
	...
	<BZ:body property="data" codeNames="ETXB;BCZL;CHILD_TYPE;CHILD_STATE;">
		<BZ:form name="srcForm" method="post" action="cms/childreturn/returnSelectFLY.action">
					...
					<td style="width: 100%;">
						<table>
						   <tr>
								...
								<td class="bz-search-title" style="width: 10%">儿童类型</td>
								<td style="width: 10%">

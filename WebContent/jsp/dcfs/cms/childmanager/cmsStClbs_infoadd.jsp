...
<table class="specialtable" align="center" style='width:98%;text-align:center'>
	<tr>
		<td class="edit-data-title" colspan="5" style="text-align:center"><b>儿童信息录入</b></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="edit-data-title">送养人<font color="red">*</font></td>
		<td class="edit-data-value"><BZ:input prefix="P_" field="SENDER" id="P_SENDER" defaultValue="" notnull="送养人不能为空！" maxlength="25" size="25"/></td>
		<td class="edit-data-title">送养人地址<font color="red">*</font></td>
		<td class="edit-data-value" colspan="2"><BZ:input prefix="P_" field="SENDER_ADDR" id="P_SENDER_ADDR" defaultValue="" notnull="送养人地址不能为空！" size="60" maxlength="100"/>		
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<BZ:select prefix="P_" field="IS_ANNOUNCEMENT" id="P_IS_ANNOUNCEMENT" formTitle="报刊公告" defaultValue="1" width="135px">

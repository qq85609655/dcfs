...
//获取修改标志，来区别取消或提交成功后所返回的列表页面
String listType = (String)request.getAttribute("listType");
System.out.println("listType"+listType+";UUID"+ciId);
...
<script type="text/javascript">
	...
	function _save(){
		...
		//if(confirm('确认要保存当前填写的数据么?')){
			...
			document.srcForm.action=path+"/cms/childManager/saveDetailInfo.action";
...
<input type="hidden" name="UUID" value="<%=ciId %>"/>
...
<table class="specialtable" align="center" style='width:98%;text-align:center'>
	...
	<%if("CMS_AZB_DL_LIST".equals(listType)||"CMS_AZB_TXSH_LIST".equals(listType)){%>	
	<tr>
...
<div class="bz-action-frame" style="text-align:center">
	<div class="bz-action-edit" desc="按钮区">
		...
		<%if("CMS_FLY_CLBS_LIST".equals(listType)||"CMS_ST_DL_LIST".equals(listType)||"CMS_AZB_DL_LIST".equals(listType)){%>

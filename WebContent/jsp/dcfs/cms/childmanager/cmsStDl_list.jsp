					...
					<td style="width: 100%;">
						<table>
							...
							<tr>
								...
								<td>
									<BZ:select prefix="S_" field="SN_TYPE" isCode="true" codeName="BCZL"  defaultValue="" formTitle="病残种类">
										<option value="">--请选择--</option>
									</BZ:select>
								</td>
							...
							<tr>
								<td class="bz-search-title"><span title="报送状态">报送状态</span></td>
								<td>
									<BZ:select prefix="S_" field="CHILD_STATE" isCode="false" defaultValue="" formTitle="报送状态">
										<BZ:option value="">--请选择--</BZ:option>
										<BZ:option value="0">未提交</BZ:option>
										<BZ:option value="1">已提交</BZ:option>
									</BZ:select>
								</td>	
								<td class="bz-search-title"><span title="录入人">录入人</span></td>
								<td>
									<BZ:input prefix="S_" field="REG_USERNAME" id="S_REG_USERNAME" defaultValue=""/>
								</td>
								<td class="bz-search-title"><span title="录入日期">录入日期</span></td>
								<td colspan="5">
    ...
    <div class="wrapper">
		...
		<div class="footer-frame">
			<table border="0" cellpadding="0" cellspacing="0" class="operation">
				<tr>
					<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="儿童材料报送数据" exportCode="SEX=CODE,ETXB;SN_TYPE=CODE,BCZL;BIRTHDAY=DATE;CHECKUP_DATE=DATE;SEND_DATE=DATE;CHILD_TYPE=CODE,CHILD_TYPE;AUD_STATE=FLAG,0:未提交&1:已提交&2:已提交&3:已提交&4:已提交&5:已提交&6:已提交&7:已提交&8:已提交&9:已提交" exportField="WELFARE_NAME_CN=福利院,30,20;NAME=姓名,15;SEX=性别,10;BIRTHDAY=出生日期,15;CHILD_TYPE=儿童类型,10;SN_TYPE=病残种类,25;CHECKUP_DATE=体检日期,15;REG_USERNAME=录入人,15;REG_DATE=录入日期,15;AUD_STATE=报送状态"/></td>				
				</tr>
			</table>
		</div>
		<!--分页功能区End -->

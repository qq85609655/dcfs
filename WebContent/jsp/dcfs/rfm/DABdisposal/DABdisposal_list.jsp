				...
				<tr>
					<td style="width: 100%;">
						<table>
							...
							<tr>	
								<td class="bz-search-title">处置人</td>
								<td>
									<BZ:input prefix="S_" field="DUAL_USERNAME" id="S_DUAL_USERNAME" defaultValue="" formTitle="处置人" maxlength="150"/>
								</td>
							...
							<tr>
								...
								<td class="bz-search-title">处置日期</td>
								<td>
		...
		<div class="page-content">
			<div class="wrapper">
				...
				<div class="table-row table-btns" style="text-align: left">
					...
					<input type="button" value="处&nbsp;&nbsp;置" class="btn btn-sm btn-primary" onclick="_disposal()"/>&nbsp;
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 5%;">
									<div class="sorting" id="DUAL_USERNAME">处置人</div>
								</th>
								<th style="width: 6%;">
									<div class="sorting" id="DUAL_DATE">处置日期</div>
								</th>
								<th style="width: 5%;">
						...
						<BZ:for property="List">
							<tr class="emptyData">
								...
								<td><BZ:data field="RETURN_STATE" defaultValue="" onlyValue="true" checkValue="2=待处置;3=已处置;"/></td>
							</tr>
						</BZ:for>
						</tbody>
					</table>
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="退文处置信息" exportCode="REGISTER_DATE=DATE;COUNTRY_CODE=CODE,GJSY;FILE_TYPE=CODE,WJLX;APPLE_DATE=DATE;APPLE_TYPE=CODE,TWLX;HANDLE_TYPE=CODE,TWCZFS_ALL;RETREAT_DATE=DATE;DUAL_DATE=DATE;RETURN_STATE=FLAG,2:待处置&3:已处置;" exportField="FILE_NO=收文编号,15,20;REGISTER_DATE=收文日期,15;COUNTRY_CODE=国家,15;NAME_CN=收养组织,15;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;FILE_TYPE=文件类型,15;APPLE_DATE=申请日期,15;RETREAT_DATE=确认日期,15;APPLE_TYPE=退文类型,15;HANDLE_TYPE=退文处置方式,15;DUAL_USERNAME=处置人,15;DUAL_DATE=处置时间,15;RETURN_STATE=退文状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

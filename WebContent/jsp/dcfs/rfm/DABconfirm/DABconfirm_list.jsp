...
<%
/**   
 * @Title: DABconfirm_list.jsp
 * @Description:  
 * @author panfeng   
 * @date 2014-9-25 下午3:11:02 
 * @version V1.0   
 */
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"rfm/DABconfirm/DABconfirmList.action?page=1";
		...
		function _reset(){
			...
			document.getElementById("S_PERSON_NAME").value = "";
		...
		function _confirm(){
			...
			for(var i=0; i<arrays.length; i++){
				...
				if(arrays[i].checked){
					if(state != "0"){
						...
						page.alert("选中文件中存在已归档文件，请将该文件进行“解除档案”操作！");
						return;
					}else{
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"rfm/DABconfirm/confirmShow.action?showuuid="+showuuid;
				document.srcForm.submit();
			}
		}
		...
		function _show(){
			...
			if(num != "1"){
				...
				window.open(path + "rfm/DABconfirm/showReturnFile.action?showuuid=" + showuuid,"newwindow","height=460,width=1000,top=70,left=180,scrollbars=yes");
			}
		}
		...
		function _cancel(){
			...
			if(num < 1){
				...
				if (confirm("确定取消选择的退文信息？")){
					...
					document.srcForm.action=path+"rfm/DABconfirm/returnFileDelete.action";
					document.srcForm.submit();
				}
			}
		}
	...
	<BZ:body property="data" codeNames="WJWZ;GJSY;SYS_GJSY_CN;SYZZ;TWLX;WJWZ">
		<BZ:form name="srcForm" method="post" action="rfm/DABconfirm/DABconfirmList.action">
		<!-- 用于保存数据结果提示 -->
					...
					<td style="width: 100%;">
						<table>
							<tr>
								...
								<td class="bz-search-title" style="width: 10%">退文类型</td>
								<td style="width: 18%">
							...
							<tr>
								...
								<td>
									<BZ:input prefix="S_" field="RETREAT_DATE_START" id="S_RETREAT_DATE_START" type="Date" dateExtend="maxDate:'#F{$dp.$D(\\'S_RETREAT_DATE_END\\')}',readonly:true" defaultValue="" formTitle="起始确认日期" />~
									<BZ:input prefix="S_" field="RETREAT_DATE_END" id="S_RETREAT_DATE_END" type="Date" dateExtend="minDate:'#F{$dp.$D(\\'S_RETREAT_DATE_START\\')}',readonly:true" defaultValue="" formTitle="截止确认日期" />
								</td>
							</tr>
							<tr>
								<td class="bz-search-title">确认人</td>
								<td>
									<BZ:input prefix="S_" field="PERSON_NAME" id="S_PERSON_NAME" defaultValue="" formTitle="确认人" maxlength="150"/>
								</td>
			...
			<div class="wrapper">
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 6%;">
									<div class="sorting" id="AF_POSITION">所在部门</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="APPLE_TYPE">退文类型</div>
								</th>
								<th style="width: 7%;">
									<div class="sorting" id="PERSON_NAME">确认人</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="RETREAT_DATE">确认日期</div>
								</th>
								<th style="width: 5%;">
									<div class="sorting" id="RETURN_STATE">确认状态</div>
								</th>
							</tr>
						</thead>
						<tbody>
						<BZ:for property="List">
							<tr class="emptyData">
								...
								<td><BZ:data field="PERSON_NAME" defaultValue="" onlyValue="true"/></td>
								<td class="center"><BZ:data field="RETREAT_DATE" defaultValue="" type="Date" onlyValue="true"/></td>
								<td><BZ:data field="RETURN_STATE" defaultValue="" onlyValue="true" checkValue="0=待确认;1=已确认;2=待处置;9=取消退文"/></td>
							</tr>
						</BZ:for>
						</tbody>
					</table>
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="退文确认信息" exportCode="REGISTER_DATE=DATE;COUNTRY_CODE=CODE,GJSY;AF_POSITION=CODE,WJWZ;APPLE_TYPE=CODE,TWLX;RETREAT_DATE=DATE;RETURN_STATE=FLAG,0:待确认&1:已确认&9:取消退文;" exportField="FILE_NO=收文编号,15,20;REGISTER_DATE=收文日期,15;COUNTRY_CODE=国家,15;NAME_CN=收养组织,15;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;AF_POSITION=所在部门,15;APPLE_TYPE=退文类型,15;PERSON_NAME=确认人,15;RETREAT_DATE=确认日期,15;RETURN_STATE=确认状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

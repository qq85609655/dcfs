					...
					<td style="width: 100%;">
						<table>
							...
							<tr>	
								...
								<td class="bz-search-title">操作日期</td>
								<td>
							...
							<tr>
								...
								<td class="bz-search-title">所在部门</td>
								<td>
		...
		<div class="page-content">
			<div class="wrapper">
				...
				<div class="table-row table-btns" style="text-align: left">
					...
					<input type="button" value="退文代录" class="btn btn-sm btn-primary" onclick="_showChoiceFile()"/>&nbsp;
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="退文代录信息" exportCode="REGISTER_DATE=DATE;COUNTRY_CODE=CODE,GJSY;FILE_TYPE=CODE,WJLX;AF_POSITION=CODE,WJWZ;APPLE_DATE=DATE;HANDLE_TYPE=CODE,TWCZFS_ALL;DUAL_DATE=DATE;RETURN_STATE=FLAG,0:待确认&1:已确认&2:待处置&3:已处置&9:取消退文;" exportField="FILE_NO=收文编号,15,20;REGISTER_DATE=收文日期,15;COUNTRY_CODE=国家,15;NAME_CN=收养组织,15;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;FILE_TYPE=文件类型,15;AF_POSITION=所在部门,15;APPLE_DATE=申请日期,15;HANDLE_TYPE=退文处置方式,15;DUAL_DATE=处置日期,15;RETURN_STATE=退文状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

...
String plan_id = data.getString("PLAN_ID");
...
<BZ:html>
	...
	<script>
		...
		function _choseForRevise(){
			...
			if(num < 1){
				...
				$("#H_CIIDS").val(ci_id);
				document.srcForm.action=path+"sce/publishPlan/toFBLXChose.action";
				document.srcForm.submit();
			}
		}
	...
	<BZ:body property="data" codeNames="BCZL;DFLX;FBZT;PROVINCE">
		<BZ:form name="srcForm" method="post" action="sce/publishPlan/toChoseETForJH.action">
		<!-- 用于保存数据结果提示 -->

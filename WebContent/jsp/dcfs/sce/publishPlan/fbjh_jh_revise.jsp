...
<BZ:html>
	...
	<script>
		...
		function _removeET(){
			if(confirm("确定移除该儿童吗？")){
				...
				if(num < 1){
					...
					$("#H_REMOVE_CIIDS").val(ci_id);
					document.srcForm.action=path+"sce/publishPlan/removeETForRevise.action";
		...
		function _toChoseETForJH(){
			...
			obj.action=path+'/sce/publishPlan/toChoseETForJH.action?PLAN_ID='+PLAN_ID;
			obj.submit();
		}

...
<%
	/**   
	* @Title: addTranslation_list.jsp
	* @Description: 预批补翻查询列表
	* @author panfeng   
...
<BZ:html>
	<BZ:head>
	  ...
	  <script type="text/javascript">
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"sce/addTranslation/addTranslationList.action?type=SHB&page=1";
		...
		function _addAudit(){
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"sce/preapproveaudit/PreApproveAuditShow.action?type=SHBadd&Level=0&FLAG=bf&RI_ID="+ri_id+"&RAU_ID="+rau_id;
				document.srcForm.submit();
			}
		}
	...
	<BZ:body property="data" codeNames="PROVINCE;ETXB;">
		<BZ:form name="srcForm" method="post" action="/sce/addTranslation/addTranslationList.action?type=SHB">

...
<BZ:html>
	...
	<script>
		...
		function open_tijiao(){
			document.srcForm.action = path + "sce/opinionTem/AZBfindListTem.action";
	...
	<BZ:body codeNames="WJMBLX;WJSHYJ;WJSHJB">
		<BZ:form name="srcForm" method="post" action="sce/opinionTem/AZBfindListTem.action">
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						...
						<BZ:for property="List" fordata="fordata">
							<tr class="emptyData">
								...
								<td><BZ:data field="AUDIT_OPTION" defaultValue="" checkValue="2=通过;3=不通过;4=补充材料" onlyValue="true"/></td>

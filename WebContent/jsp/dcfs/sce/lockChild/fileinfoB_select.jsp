...
<%
/**   
 * @Title: fileinfoB_select.jsp
 * @Description: 锁定类型为B的文件信息列表
 * @author yangrt   
 * @date 2014-9-21
 * @version V1.0  
 */
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"sce/lockchild/FileInfoSelect.action?type=B&page=1";
		...
		function _showFileData(af_id){
			var url = path + "sce/lockchild/GetAdoptionPersonInfo.action?Flag=EN&type=B&AF_ID=" + af_id;
			_open(url,"window",950,600);
		}
		
	</script>
	<BZ:body property="searchData" codeNames="WJLX;PROVINCE;SDFS;ADOPTER_CHILDREN_SEX;">
		<BZ:form name="srcForm" method="post" action="sce/lockchild/FileInfoSelect.action?type=B">
		<!-- 用于保存数据结果提示 -->
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 8%;">
									<div class="sorting" id="REG_STATE">锁定儿童<br>Child locked</div>
								</th>
								<th style="width: 10%;">
						...
						<BZ:for property="List">
							<tr class="emptyData">
								...
								<td><BZ:data field="WELFARE_NAME_EN" defaultValue="" onlyValue="true"/></td>

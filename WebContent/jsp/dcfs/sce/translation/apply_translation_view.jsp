<%
/**   
 * @Title: apply_translation_view.jsp
 * @Description:  预批申请翻译查看页面
 * @author panfeng   
...
<BZ:html>
	...
	<script>
		...
		//返回列表
		function _goback(){
			window.location.href= path + 'sce/translation/applyTranslationList.action';
		}
	</script>
</BZ:html>
<BZ:body property="data" codeNames="GJ">
	...
	<BZ:input type="hidden" prefix="R_" field="MALE_JOB_CN"              id="R_MALE_JOB_CN" defaultValue=""/>
	<BZ:input type="hidden" prefix="R_" field="MALE_JOB_EN"              id="R_MALE_JOB_EN" defaultValue=""/>
	<BZ:input type="hidden" prefix="R_" field="FEMALE_JOB_CN"            id="R_FEMALE_JOB_CN" defaultValue=""/>
	...
	<BZ:input type="hidden" prefix="R_" field="CHILD_CONDITION_CN"       id="R_CHILD_CONDITION_CN" defaultValue=""/>
	<BZ:input type="hidden" prefix="R_" field="CHILD_CONDITION_EN"       id="R_CHILD_CONDITION_EN" defaultValue=""/>
	<BZ:input type="hidden" prefix="R_" field="ADOPT_REQUEST_CN"         id="R_ADOPT_REQUEST_CN" defaultValue=""/>
	...
	<div id="tab-container" class='tab-container'>
			...
			<div id="tab2">
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="TENDING_CN" defaultValue="" />
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">外文(EN)</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="TENDING_EN" defaultValue="" />
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="tab3">
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title" width="10%">中文(CN)</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="OPINION_CN" defaultValue="" />
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">外文(EN)</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="OPINION_EN" defaultValue="" />
						</td>
					</tr>
				</table>
			</div>
		...
		<div id="tab-translation">
			<table class="specialtable" align="center" style="width:98%;text-align:center">
				<tr>
                    <td class="bz-edit-data-title" colspan="6" style="text-align:center"><b>翻译信息</b></td>
                </tr>
                <tr>
					<td class="bz-edit-data-title" width="15%">翻译说明</td>
					<td class="bz-edit-data-value" colspan="5">
				...
				<tr>
					...
					<td class="bz-edit-data-title" width="15%">翻译完成日期</td>

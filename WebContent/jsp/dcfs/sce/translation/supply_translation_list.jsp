...
<%
/**   
 * @Title: supply_translation_list.jsp
 * @Description: 预批补充翻译列表
 * @author panfeng
 * @date 2014-10-16 
 * @version V1.0   
 */
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"sce/translation/supplyTranslationList.action?page=1";
		...
		function _translation(){
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"sce/translation/supplyTranslation.action?type=tran&showuuid=" + showuuid;
				document.srcForm.submit();
			}
		}
		...
		function _show(){
			...
			if(num != "1"){
				...
				url = path+"sce/translation/supplyTranslation.action?type=show&showuuid=" + showuuid;
	...
	<BZ:body property="data" codeNames="GJSY;ETXB;PROVINCE;SYS_GJSY_CN">
		<BZ:form name="srcForm" method="post" action="sce/translation/supplyTranslationList.action">
		<!-- 用于保存数据结果提示 -->
					...
					<td style="width: 100%;">
						<table>
							...
							<tr>
								...
								<td>
									<BZ:select prefix="S_"  id="S_PROVINCE_ID" field="PROVINCE_ID" onchange="selectWelfare(this)"  width="80%"  isCode="true"  codeName="PROVINCE" formTitle="省份" defaultValue="">
					 	                <BZ:option value="">--请选择--</BZ:option>
					                </BZ:select>
								</td>
			...
			<div class="wrapper">
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 7%;">
									<div class="sorting" id="TRANSLATION_STATE">补翻状态</div>
								</th>
							</tr>
						</thead>
						<tbody>
						<BZ:for property="List">
							<tr class="emptyData">
								...
								<td><BZ:data field="FEEDBACK_DATE" type="Date" defaultValue="" onlyValue="true"/></td>
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="预批补充翻译信息" 
							exportCode="COUNTRY_CODE=CODE,GJSY;PROVINCE_ID=CODE,PROVINCE;SEX=CODE,ETXB;BIRTHDAY=DATE;FEEDBACK_DATE=DATE;COMPLETE_DATE=DATE;TRANSLATION_STATE=FLAG,0:待翻译&1:翻译中&2:已翻译;"
							exportField="COUNTRY_CODE=国家,15,20;ADOPT_ORG_NAME_CN=收养组织,15;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;PROVINCE_ID=省份,15;WELFARE_NAME_CN=福利院,15;NAME=儿童姓名,15;SEX=性别,15;BIRTHDAY=出生日期,15;FEEDBACK_DATE=反馈日期,15;COMPLETE_DATE=完成日期,15;TRANSLATION_STATE=翻译状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

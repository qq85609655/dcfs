		...
		<div class="bz-edit clearfix" desc="编辑区域" style="width: 100%">
			<div class="ui-widget-content ui-corner-all bz-edit-warper">
				<div class="ui-state-default bz-edit-title" desc="标题">
					...
					<div class="title3" style="height: 40px;">特需儿童-抚育计划(SN child-Care plan)</div>
				</div>
				<!-- 内容区域 begin -->
				<div class="bz-edit-data-content clearfix" desc="内容体">
					<table class="bz-edit-data-table table-print" border="0">
						<tr>
							<td class="bz-edit-data-title" width="10%">省厅<br>Provincial Civil Affairs Department</td>
						...
						<tr>
							<td class="bz-edit-data-value" colspan="8">
								医疗康复及抚育计划（英文）<br>Medical rehabilitation and care plan (English)<br>
								<BZ:dataValue field="TENDING_EN" style="width:96%;height:400px;" defaultValue="" onlyValue="true"/><br>
								<%-- 收养人意见<br>Decision of Adopter:<br><br>
								<BZ:dataValue field="TENDING_EN" style="width:96%;height:400px;" defaultValue="" onlyValue="true"/><br>
								收养人签名<br>Signature of adoptive father:<br><br>

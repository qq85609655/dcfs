<%
/**   
 * @Title: preadoptioninfoEN_doubleadd.jsp
...
<BZ:html>
		...
		function _applySubmit(val){
			...
			if(val == "0"){
				...
				if(isSubmit == "true"){
					...
					alert("该预批的之前预批已经递交特需文件，不能提交此预批申请！");
	...
	<BZ:body property="applydata" codeNames="GJ;SYLX;ADOPTER_EDU;ADOPTER_HEALTH;HBBZ;PROVINCE;ADOPTER_CHILDREN_SEX;BCZL;">
		...
		<div class="bz-edit clearfix" desc="编辑区域" id="AdopterInfo">
			<div class="ui-widget-content ui-corner-all bz-edit-warper">
				...
				<div class="ui-state-default bz-edit-title" desc="标题">
					...
					<div>收养人基本情况(Adopter basic information)</div>
				</div>
				<!-- 标题区域 end -->
				<!-- 内容区域 begin -->
					...
					<table class="bz-edit-data-table" border="0">
						...
						<tr>
							...
							<td class="bz-edit-data-value" colspan="3">
								...
								<BZ:input prefix="R_" field="IS_FAMILY_OTHERS_EN" id="R_IS_FAMILY_OTHERS_EN" formTitle="" defaultValue="" type="textarea" maxlength="500" style="display:none;width:80%"/>
							</td>
						</tr>
						<tr>
				...
				<div class="bz-edit-data-content clearfix" desc="内容体">
					<table class="bz-edit-data-table" border="0">
						...
						<tr class="ENinfo">
							<td class="bz-edit-data-title" width="10%">病残诊断<br>Diagnosis</td>
							<td class="bz-edit-data-value" colspan="7">
								<BZ:dataValue field="DISEASE_EN" property="childData" defaultValue="" isShowEN="true" onlyValue="true"/>
							</td>
						</tr>
						<tr class="CNinfo">
							<td class="bz-edit-data-title" width="10%">儿童姓名<br>Child name</td>
						...
						<tr class="CNinfo">
							<td class="bz-edit-data-title" width="10%">病残诊断<br>Diagnosis</td>
							<td class="bz-edit-data-value" colspan="7">
								<BZ:dataValue field="DISEASE_CN" property="childData" defaultValue="" isShowEN="true" onlyValue="true"/>
							</td>
						</tr>
						</BZ:for>
						<tr id="TendingENInfo">

<%
/**   
 * @Title: FLY_notice_list.jsp
 * @Description: 福利院送养通知书列表
 * @author xugy
 * @date 2014-11-8下午5:27:32
 * @version V1.0   
 */
%>
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"notice/FLYNoticeList.action?page=1";
		...
		function _detail(){
			...
			if(num != 1){
				...
				document.srcForm.action=path+"notice/FLYNoticeAttDetail.action";
				document.srcForm.submit();
	...
	<BZ:body property="data" codeNames="PROVINCE;ETXB;GJSY;SYS_GJSY_CN;">
		<BZ:form name="srcForm" method="post" action="notice/FLYNoticeList.action">
					...
					<td style="width: 100%;">
						<table>
							...
							<tr>	
								...
								<td>
									<BZ:select prefix="N_" field="CHILD_TYPE" id="N_CHILD_TYPE" width="148px" formTitle="儿童类型" defaultValue="">
										<BZ:option value="">--请选择--</BZ:option>

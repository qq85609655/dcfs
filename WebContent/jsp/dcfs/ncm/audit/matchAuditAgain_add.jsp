<%
/**   
 * @Title: matchAuditAgain_add.jsp
 * @Description: 匹配复核信息添加
 * @author xugy
 * @date 2014-9-9下午7:44:15
 * @version V1.0   
 */
%>
...
String RI_ID = data.getString("RI_ID","");//儿童材料ID
...
function _save(){
	...
	document.srcForm.action=path+"matchAudit/auditAgainSave.action";
...
<BZ:input prefix="CI_" field="CI_ID" defaultValue="" type="hidden"/>
	<div id="tab-container" class='tab-container'>
		...
		<div class='panel-container'>
			<table class="specialtable">
				<tr>
					<td class="edit-data-title" style="text-align:center"><b>经办人审核信息</b></td>
				</tr>
				<tr>
					<td>
						<table class="specialtable">
							<tr>
								...
								<td class="edit-data-value" width="23%">
									<BZ:dataValue field="FIRST_AUDIT_DATE" defaultValue="" onlyValue="true" type="date"/>
								</td>
								<td class="edit-data-title" width="10%">审核人</td>
								<td class="edit-data-value" width="23%">
									<BZ:dataValue field="FIRST_AUDIT_USERNAME" defaultValue="" onlyValue="true"/>
								</td>
								<td class="edit-data-title" width="10%">审核结果</td>
								<td class="edit-data-value" width="24%">
									<BZ:dataValue field="FIRST_AUDIT_OPTION" defaultValue="" onlyValue="true" checkValue="0=通过;1=不通过;"/>
								</td>
							</tr>
							<tr>
								<td class="edit-data-title">审核意见</td>
								<td class="edit-data-value" colspan="5">
									<BZ:dataValue field="FIRST_AUDIT_CONTENT" defaultValue="" onlyValue="true"/>
								</td>
							</tr>
							<tr>
								<td class="edit-data-title">备注</td>
								<td class="edit-data-value" colspan="5">
									<BZ:dataValue field="FIRST_AUDIT_REMARKS" defaultValue="" onlyValue="true"/>
								</td>
							</tr>
						</table>
					</td>

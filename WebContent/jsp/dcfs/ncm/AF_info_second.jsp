...
<%-- <%=path%>/match/showAFInfoSecond.action?AF_ID=<%=AF_ID%> --%>
	<table class="bz-edit-data-table" border="0" id="tab">
		...
		%>
		<tr>
			<td class="bz-edit-data-title" width="15%">收养人<br/>(EN)</td>
			...
			<td class="bz-edit-data-title" width="15%">性别<br/>(EN)</td>
			<td class="bz-edit-data-value" width="35%">
				<%
		...
		<tr>
			<td class="bz-edit-data-title">出生日期<br/>(EN)</td>
			...
			<td class="bz-edit-data-title">年龄<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
		...
		<tr>
			<td class="bz-edit-data-title">国籍<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
			...
			<td class="bz-edit-data-title">护照号码<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
			...
			%>
		<tr>
			<td class="bz-edit-data-title">婚姻状况<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<BZ:dataValue field="" defaultValue="Cohabitating"/>
			</td>
			<td class="bz-edit-data-title">结婚日期<br/>(EN)</td>
			<td class="bz-edit-data-value">
			...
			%>
		<tr>
			<td class="bz-edit-data-title">受教育情况<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
			...
			<td class="bz-edit-data-title">职业<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
		...
		<tr>
			<td class="bz-edit-data-title">健康状况<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
			...
			<td class="bz-edit-data-title">违法行为及刑事处罚<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
		...
		<tr>
			<td class="bz-edit-data-title">有无不良嗜好<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<%
				if("1".equals(ADOPTER_SEX)){
				%>
		...
		<tr>
			<td class="bz-edit-data-title">家庭总资产<br/>(EN)</td>
			<td class="bz-edit-data-value">
			...
			<td class="bz-edit-data-title">家庭总债务<br/>(EN)</td>
			<td class="bz-edit-data-value">
		...
		<tr>
			<td class="bz-edit-data-title">家庭净资产<br/>(EN)</td>
			<td class="bz-edit-data-value">
		...
		<tr>
			...
			<td class="bz-edit-data-title" width="40%" style="text-align: center;" ><b>男收养人(EN)</b></td>
			<td class="bz-edit-data-title" width="40%" style="text-align: center;" ><b>女收养人(EN)</b></td>
		</tr>
		<tr>
			<td class="bz-edit-data-title">姓名<br/>(EN)</td>
			<td class="bz-edit-data-value">
				<BZ:dataValue field="MALE_NAME" defaultValue="" onlyValue="true"/>
			</td>
			<td class="bz-edit-data-value">
		...
		<tr>
			<td class="bz-edit-data-title">子女数量及情况<br/>(EN)</td>
			<td class="bz-edit-data-value" colspan="2">
				<BZ:dataValue field="CHILD_CONDITION_EN" defaultValue="" onlyValue="true"/>
			</td>
		</tr>
		<tr>
			<td class="bz-edit-data-title">家庭地址<br/>(EN)</td>
			<td class="bz-edit-data-value" colspan="2">
				<BZ:dataValue field="ADDRESS" defaultValue="" onlyValue="true"/>
			</td>
		</tr>

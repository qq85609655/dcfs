<%
/**   
 * @Title: CISpecialMatch_list.jsp.jsp
 * @Description: 选择特需儿童匹配列表
 * @author xugy
 * @date 2014-9-6上午11:07:59
 * @version V1.0   
 */
%>
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"specialMatch/CISpecialMatchList.action?page=1";
		...
		function _match(){
			...
			if(num != "1"){
				...
				document.srcForm.action=path+"specialMatch/specialMatchPreview.action?CIid="+CIid+"&AFid="+AFid;
				document.srcForm.submit();
				//}
			}
		}
	...
	<BZ:body property="data" codeNames="PROVINCE;ETXB;">
		<BZ:form name="srcForm" method="post" action="specialMatch/CISpecialMatchList.action">

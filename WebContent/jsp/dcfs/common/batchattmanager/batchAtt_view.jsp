...
<%
	...
	String title_preview = "预览";
	if("true".equals(IS_EN)){
		title_preview = "preview";
	}
	String title_download = "下载";
	if("true".equals(IS_EN)){
		title_download = "download";
	}
	String title_delete = "删除";
	if("true".equals(IS_EN)){
		title_delete = "delete";
	}
%>
...
$(document).ready( function() {
	//dyniframesize(['frmUpload']);//公共功能，框架元素自适应
	setSigle();
	dyniframesize(['frmUpload','mainFrame']);
	dyniframesize(['frmUpload1','mainFrame']);

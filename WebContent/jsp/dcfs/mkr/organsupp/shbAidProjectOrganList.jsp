...
<BZ:html>
	...
	<script>
		...
		function _create(){
			...
			var id = "<%=id%>";
			iframeC.location = "<%=request.getContextPath() %>/mkr/organSupp/aidProjectModify.action?ID="+id+"&type=shb";
		}
		...
		function showAidProject(){
			...
			iframeC.location = "<%=request.getContextPath() %>/mkr/organSupp/aidProjectModify.action?aidProjectId="+id+"type=shb";
		}

	...
	<div class="bz-edit clearfix" desc="编辑区域">
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			<div class="ui-state-default bz-edit-title" desc="标题">
				...
				<div>
					援助和捐助项目信息(Sponsorship program information)
				</div>
			</div>
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					<tr>
						<td class="bz-edit-data-title">项目名称<br>Program</td>
						...
						<td class="bz-edit-data-title">项目负责人<br>Program manager</td>
						<td class="bz-edit-data-value">
							<BZ:input field="ITEM_HEADER" defaultValue="" prefix="MKR_" maxlength="20" style="width:90%" notnull="请输入项目负责人"/>					
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">合作方名称<br>Program partner</td>
						<td class="bz-edit-data-value">
						...
						<td class="bz-edit-data-title">受益对象<br>Beneficiary</td>
						<td class="bz-edit-data-value">
							<BZ:input field="PROFITOR" style="width:90%"  defaultValue="" prefix="MKR_" maxlength="20"/>	
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">开始时间<br>Date of start</td>
						<td class="bz-edit-data-value">
							<BZ:input field="BEGIN_TIME" type="date" style="width:100px" id="MKR_BEGIN_TIME" dateExtend="maxDate:'#F{$dp.$D(\\'MKR_END_TIME\\')}',readonly:true,lang:'en'" defaultValue="" prefix="MKR_"/>
						</td>
						<td class="bz-edit-data-title">结束时间<br>Date of completion</td>
						<td class="bz-edit-data-value">
							<BZ:input field="END_TIME" style="width:100px"  type="date" id="MKR_END_TIME"   dateExtend="minDate:'#F{$dp.$D(\\'MKR_BEGIN_TIME\\')}',readonly:true,lang:'en'" defaultValue="" prefix="MKR_"/>			
											
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">投入金额<br>Investment amount</td>
						<td class="bz-edit-data-value">
					...
					<tr>
						<td class="bz-edit-data-title">项目所在地<br>Program location</td>
						<td class="bz-edit-data-value" colspan="3">

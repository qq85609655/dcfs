...
<BZ:html>
	<BZ:head language="EN">
		<title>更新记录(Updated information)</title>
	...
	<BZ:body property="data">
		<BZ:form name="srcForm" method="post" action="mkr/organSupp/organUpdateList.action">
					...
					<table class="table table-striped table-bordered table-hover dataTable" style="word-break:break-all; overflow:auto;" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<!-- <th style="width: 10%;">
									<div class="sorting" id="IP_ADDR">行为者IP(Operator IP)</div>
								</th> -->
								<th style="width: 8%;">
									<div class="sorting" id="OPERATOR">更新人(Updated by)</div>
								</th>
								<th style="width: 10%;">
									<div class="sorting" id="CNAME">收养组织(Agency)</div>
								</th>
								<th style="width: 10%;">
									<div class="sorting" id="OPERATE_TIME">更新时间(Update date)</div>
								</th>
								<th style="width: 10%;">
									<div class="sorting" id="OPERATE_RESULT">操作结果(Operation result)</div>
								</th>
							</tr>
						</thead>
						<tbody>

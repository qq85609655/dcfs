			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" field="SEX" id="MKR_SEX" width="100px" isCode="true" notnull="请选择性别" codeName="SEX" formTitle="性别" defaultValue="">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" width="100px;" field="ID_TYPE" id="MKR_ID_TYPE" isCode="true" codeName="CARD_CODE" formTitle="身份证明种类" defaultValue="">
								<BZ:option value="">--身份证明种类--</BZ:option>
							</BZ:select>				
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:select field="IS_TEMP_JOB" formTitle="" prefix="MKR_" width="100px;">
								<BZ:option value="">--是否兼职--</BZ:option>

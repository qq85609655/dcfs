...
<BZ:html>
	<BZ:head language="EN">
		<title>在华旅行接待(Tour reception in China)</title>
	...
	<script>
		...
		function _create(){
			...
			var id = "<%=id%>";
			iframeC.location = "<%=request.getContextPath() %>/mkr/organSupp/receptionModify.action?ID="+id;
		}
		...
		function showReception(){
			...
			iframeC.location = "<%=request.getContextPath() %>/mkr/organSupp/receptionModify.action?receptionId="+id;
		}
		...
		function _delete(){
			...
			document.location= "<%=request.getContextPath() %>/mkr/organSupp/receptionOrganList.action?ID=<%=id%>";
		}
	</script>
					...
					<table class="table table-striped table-bordered table-hover dataTable" style="word-break:break-all; overflow:auto;" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 10%;">
									<div class="sorting" id="RECEIVE_TYPE">接待方类型<br>(Recipient)</div>
								</th>
								<th style="width: 10%;">
									<div class="sorting" id="HEADER_TYPE">负责人类别<br>(Person in charge)</div>
								</th>
								<th style="width: 7%;">
									<div class="sorting" id="NAME">姓名<br>(Name)</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="ID_NUMBER">身份证号码<br>(ID number)</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="WORK_UNIT">工作单位<br>(Organization/Company)</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="TELEPHONE">电话号码<br>(Telephone)</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="MOBEL">手机号码<br>(Cellphone)</div>
								</th>
								<th style="width: 8%;">
								...
								<th style="width: 8%;">
									<div class="sorting" id="ADDR">地址<br>(Address)</div>
								</th>
							</tr>
						</thead>
						<tbody>
						<BZ:for property="dataList">
							<tr class="emptyData">
								...
								<td><BZ:data field="RECEIVE_TYPE" codeName="JDFLX" isShowEN="true" defaultValue="" onlyValue="true"/></td>
								<td><BZ:data field="HEADER_TYPE"  codeName="FZRLB" isShowEN="true" defaultValue="" onlyValue="true"/></td>

			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" field="SEX" id="MKR_SEX" width="100px" isCode="true" notnull="请选择性别" codeName="SEX" isShowEN="true" formTitle="性别" defaultValue="">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:input field="BIRTHDAY" type="date" defaultValue="" dateExtend="lang:'en'"  style="width:100px;" prefix="MKR_" notnull="请输入出生日期" />	
							<BZ:input field="ID" defaultValue="" id="MKR_ID" prefix="MKR_" type="hidden"/>
						</td>
						<td class="bz-edit-data-title">国籍<br>Nationality</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_"  width="100px;"  field="COUNTRY_ID" id="MKR_COUNTRY_ID" isCode="true" codeName="GJ" isShowEN="true" formTitle="国家" defaultValue="">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">身份证明种类<br>Type of ID</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" width="100px;" field="ID_TYPE" id="MKR_ID_TYPE" isCode="true" codeName="CARD_CODE" isShowEN="true" formTitle="身份证明种类" defaultValue="">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>				
						</td>
						<td class="bz-edit-data-title">身份证明号码<br>ID number</td>
						<td class="bz-edit-data-value">
							<BZ:input field="ID_NUMBER" style="width:90%;" defaultValue="" prefix="MKR_" id="MKR_ID_NUMBER" restriction="number" maxlength="20"/>					
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">学历<br>Education background</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" width="100px;" field="EDUCATION" id="MKR_EDUCATION" isCode="true" codeName="ADOPTER_EDU" isShowEN="true" formTitle="学历" defaultValue="">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>				
						</td>
						<td class="bz-edit-data-title">所学专业<br>Major(s)</td>
						<td class="bz-edit-data-value" colspan="3">
							<BZ:input field="PROFESSIONAL" style="width:90%;" defaultValue="" prefix="MKR_" maxlength="20"/>			
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">毕业院校<br>University(ies)</td>
						<td class="bz-edit-data-value">
							<BZ:input field="SCHOOL" style="width:90%;" defaultValue="" prefix="MKR_" maxlength="20"/>						
						</td>
						<td class="bz-edit-data-title">联系地址<br>Address</td>
						<td class="bz-edit-data-value" colspan="3">
					...
					<tr>
						...
						<td class="bz-edit-data-title">手机<br>Cellphone</td>
						<td class="bz-edit-data-value" colspan="3">
					...
					<tr>
						<td class="bz-edit-data-title">是否兼职<br>Part-time job</td>
						<td class="bz-edit-data-value">
					...
					<tr>
						<td class="bz-edit-data-title">委托期限<br>Term of authorization</td>
					...
					<tr>
						<td class="bz-edit-data-title">委托事项<br>Job description</td>
						<td class="bz-edit-data-value" colspan="5">
					...
					<tr>
						<td class="bz-edit-data-title">个人简历<br>Resume</td>
						<td class="bz-edit-data-value" colspan="5">

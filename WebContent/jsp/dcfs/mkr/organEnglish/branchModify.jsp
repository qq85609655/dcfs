...
<BZ:head>
	...
	function _save(){
		if (_check(document.organForm)) {
			document.organForm.action=path+"mkr/orgexpmgr/branchModifySubmitEn.action";
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title">负责人</td>
					...
					<tr>
						<td class="bz-edit-data-title">邮件</td>
						<td class="bz-edit-data-value">
					...
					<tr>
						<td class="bz-edit-data-title">基本情况介绍</td>
						<td class="bz-edit-data-value" colspan="3">

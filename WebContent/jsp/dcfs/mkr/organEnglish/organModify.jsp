...
<BZ:head>
	...
	function _save(){
		...
		document.organForm.action=path+"mkr/orgexpmgr/organModifySubmitEn.action";
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title">中文名称(CN)English</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="CNAME" onlyValue="true" defaultValue='' />					
						</td>
						<td class="bz-edit-data-title" rowspan="3">组织标识(LOGO)</td>

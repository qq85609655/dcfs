...
<BZ:head>
	...
	function _save(){
    	...
    	if (_check(document.organForm)) {
			document.organForm.action=path+"mkr/organSupp/receptionModifySubmitEn.action";
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title">接待方类型</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" field="RECEIVE_TYPE" id="MKR_RECEIVE_TYPE" width="170px" isCode="true" codeName="JDFLX" formTitle="接待方类型" notnull="请输入接待方类型" defaultValue="">
								<BZ:option value="">--请选择--</BZ:option>
							</BZ:select>	
							<BZ:input field="ADOPT_ORG_ID" id="MKR_ADOPT_ORG_ID" type="hidden" defaultValue="" prefix="MKR_"/>
						</td>
						<td class="bz-edit-data-title">负责人类别</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="MKR_" field="HEADER_TYPE" width="170px" id="MKR_HEADER_TYPE" isCode="true" codeName="FZRLB" notnull="请输入负责人类别" formTitle="负责人类别" defaultValue="">
								<BZ:option value="">--请选择--</BZ:option>
							</BZ:select>					
						</td>
					</tr>

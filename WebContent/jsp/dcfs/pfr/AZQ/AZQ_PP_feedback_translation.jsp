<%
/**   
 * @Title: AZQ_PP_feedback_translation.jsp
 * @Description: 安置后报告翻译
 * @author xugy
 * @date 2014-10-14上午9:58:23
 * @version V1.0   
 */
%>
...
function _save(){
	...
	document.srcForm.action=path+"feedback/saveAZQPPFeedbackTranslation.action";
...
function _submit(){
	...
	if(confirm('确认要提交该报告翻译吗?')){
		document.srcForm.action=path+"feedback/submitAZQPPFeedbackTranslation.action";
		document.srcForm.submit();
	}else{
		return;
	}
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value" width="35%">
							<BZ:input prefix="FR_" field="VISIT_DATE" type="date" defaultValue="" formTitle="社工家访日期" notnull="家访日期不能为空"/>
						</td>
					</tr>
					<tr>
						...
						<td class="bz-edit-data-value">
							...
							<td class="bz-edit-data-value">
								<BZ:input prefix="FR_" field="FINISH_DATE" type="date" defaultValue="" formTitle="报告完成日期" notnull="报告完成日期不能为空"/>
							</td>
						</td>
					</tr>
					<tr>
						...
						<td class="bz-edit-data-value" colspan="3">
							<BZ:select prefix="FR_" field="IS_PUBLIC" defaultValue="" formTitle="本报告可否用于宣传" width="135px" notnull="请选择可否用于宣传">
								<BZ:option value="0">--请选择--</BZ:option>
					...
					<tr>
						...
						<td class="bz-edit-data-value" colspan="3">
							<BZ:input prefix="FT_" field="TRANSLATION_DESC" type="textarea" defaultValue="" style="width:99%;height:60px;" formTitle="翻译说明" />
						</td>
					</tr>
				</table>
			</div>

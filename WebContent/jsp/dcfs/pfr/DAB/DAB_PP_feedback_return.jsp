 ...
 * @Description: 收养组织安置后报告退回
 * @author xugy
 * @date 2014-10-15下午6:09:23
 * @version V1.0   
 */
%>
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title"><font color="red">*</font>退回原因</td>
						<td class="bz-edit-data-value" colspan="3">
							<BZ:select prefix="FR_" field="RETURN_REASON" isCode="true" codeName="AZHBGTUYY" formTitle="退回原因" width="200px" notnull="请选择退回原因">

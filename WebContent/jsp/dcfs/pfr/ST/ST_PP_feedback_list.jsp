<%
/**   
 * @Title: ST_PP_feedback_list.jsp
 * @Description: 省厅查看列表
 * @author xugy
 * @date 2014-10-23上午10:22:34
 * @version V1.0   
 */
%>
...
<BZ:html>
	...
	<script>
		...
		//执行按条件查询操作
		function _search(){
			document.srcForm.action=path+"feedback/STPPFeedbackList.action?page=1";
		...
		function _detail(){
			...
			if(num != 1){
				...
				document.srcForm.action=path+"feedback/PPFeedbackRecordDetail.action?type=ST";
				document.srcForm.submit();
			}
		}
	</script>
	<BZ:body property="data" codeNames="GJSY;SYS_GJSY_CN;">
		<BZ:form name="srcForm" method="post" action="feedback/STPPFeedbackList.action">
			...
			<div class="wrapper">
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="安置后报告数据" exportCode="REPORT_DATE1=DATE;REPORT_DATE2=DATE;REPORT_DATE3=DATE;REPORT_DATE4=DATE;REPORT_DATE5=DATE;REPORT_DATE6=DATE,yyyy/MM/dd" exportField="COUNTRY_CN=国家,15,20;NAME_CN=收养组织,15;MALE_NAME=男方,15;FEMALE_NAME=女方,15;WELFARE_NAME_CN=福利院,15;NAME=儿童姓名,15;REPORT_DATE1=第一次反馈日期,15;REPORT_DATE2=第二次反馈日期,15;REPORT_DATE3=第三次反馈日期,15;REPORT_DATE4=第四次反馈日期,15;REPORT_DATE5=第五次反馈日期,15;REPORT_DATE6=第六次反馈日期,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

<%
/**   
 * @Title: SYZZ_PP_feedback_additonal_mod.jsp
 * @Description: 收养组织安置后报告补充修改
 * @author xugy
 * @date 2014-10-24上午10:48:23
 * @version V1.0   
 */
%>
...
function _save(){
	...
	if(confirm('确认要保存该报告的修改吗?')){
		document.srcForm.action=path+"feedback/saveSYZZPPFeedbackAdditonalMod.action";
...
<BZ:input type="hidden" prefix="FI_" field="FEEDBACK_ID" defaultValue=""/>
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title"><font color="red">*</font>制作报告组织</td>
						<td class="bz-edit-data-value">
							<BZ:input prefix="FR_" field="ORG_NAME" defaultValue="" formTitle="制作报告组织" notnull="组织不能为空"/>
						</td>
						<td class="bz-edit-data-title"><font color="red">*</font>社工家访日期</td>
						<td class="bz-edit-data-value">
			...
			<div class="ui-state-default bz-edit-title" desc="标题">
				...
				<div>安置后报告附件
					...
					%>
					<span><input type="button" value="上传附件" class="btn btn-sm btn-primary" onclick="_toipload('EN')"/></span>
					<%} %>
				</div>
			</div>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table" border="0">
					<tr>
						...
						<td class="bz-edit-data-value" width="35%">
							<BZ:select prefix="FR_" field="FEELING_CN" defaultValue="" isCode="true" codeName="SYRGS" isShowEN="true" formTitle="收养人感受" width="135px" notnull="请选择收养人感受">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>
						</td>
						<td class="bz-edit-data-title" width="15%"><font color="red">*</font>融合情况</td>
						<td class="bz-edit-data-value" width="35%">
							<BZ:select prefix="FR_" field="FUSION_CN" defaultValue="" isCode="true" codeName="RHQK" isShowEN="true" formTitle="融合情况" width="135px" notnull="请选择融合情况">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>
						</td>
					</tr>
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:select prefix="FR_" field="HEALTHY_CN" defaultValue="" isCode="true" codeName="JKZK_AZHBG" isShowEN="true" formTitle="健康状况" width="135px" notnull="请选择健康状况">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>
						</td>
						<td class="bz-edit-data-title"><font color="red">*</font>社工评价</td>
						<td class="bz-edit-data-value">
							<BZ:select prefix="FR_" field="EVALUATION_CN" defaultValue="" isCode="true" codeName="SGPJ" isShowEN="treu" formTitle="社工评价" width="135px" notnull="请选择社工评价">
								<BZ:option value="">--Please select--</BZ:option>
							</BZ:select>
						</td>
					</tr>
	...
	<div class="bz-action-frame">
		<div class="bz-action-edit" desc="按钮区">
			...
			<input type="button" value="Back" class="btn btn-sm btn-primary" onclick="_close()" />
		</div>
	</div>
	<!-- 按钮区 结束 -->
</BZ:form>

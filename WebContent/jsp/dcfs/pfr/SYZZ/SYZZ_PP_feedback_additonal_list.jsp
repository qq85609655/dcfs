 ...
 * @Description: 收养组织安置后报告b补充列表
 * @author xugy
 * @date 2014-10-21下午8:41:34
 * @version V1.0   
 */
%>
					...
					<td style="width: 100%;">
						<table>
							...
							<tr>
								...
								<td>
									<BZ:input prefix="S_" field="NOTICE_DATE_START" id="S_NOTICE_DATE_START" type="Date" dateExtend="maxDate:'#F{$dp.$D(\\'S_NOTICE_DATE_END\\')}',readonly:true,lang:'en'" defaultValue="" formTitle="起始通知日期" />~
									<BZ:input prefix="S_" field="NOTICE_DATE_END" id="S_NOTICE_DATE_END" type="Date" dateExtend="minDate:'#F{$dp.$D(\\'S_NOTICE_DATE_START\\')}',readonly:true,lang:'en'" defaultValue="" formTitle="截止通知日期" />
								</td>
							</tr>
							<tr>	
								...
								<td> 
									<BZ:select prefix="S_" field="AA_STATUS" id="S_AA_STATUS" width="148px" formTitle="补充状态" defaultValue="">
										<BZ:option value="">--Please select--</BZ:option>
			...
			<div class="wrapper">
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 7%;">
									<div class="sorting" id="NOTICE_DATE">通知日期<br>(Date of notification)</div>
								</th>
								<th style="width: 7%;">
									<div class="sorting" id="FEEDBACK_DATE">提交日期<br>(Submission date)</div>
								</th>
								<th style="width: 5%;">
									<div class="sorting" id="AA_STATUS">补充状态<br>(Supplement status)</div>
								</th>
							</tr>
						</thead>
						<tbody>
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page isShowEN="true" form="srcForm" property="List" type="EN" exportXls="true" exportTitle="安置后反馈报告补充数据" exportCode="PROVINCE_ID=CODE,PROVINCE;AA_STATUS=FLAG,0:to be added&1:in process of adding&2:added;NOTICE_DATE=DATE;FEEDBACK_DATE=DATE,yyyy/MM/dd" exportField="FILE_NO=收文编号(Log-in No.),15,20;SIGN_NO=签批号(Application number),15;MALE_NAME=男方(Adoptive father),15;FEMALE_NAME=女方(Adoptive mother),15;PROVINCE_ID=省份(Province),15;WELFARE_NAME_EN=福利院(SWI),15;NAME_PINYIN=姓名拼音(Name(EN)),15;NUM=次第数(Number of post-placement reports),15;NOTICE_DATE=通知日期(Date of notification),15;FEEDBACK_DATE=提交日期(Submission date),15;AA_STATUS=补充状态(Supplement status),15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

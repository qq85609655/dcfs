					...
					<td style="width: 100%;">
						<table>
							...
							<tr>	
								...
								<td>
									<BZ:select prefix="S_" field="IS_CONVENTION_ADOPT" id="S_IS_CONVENTION_ADOPT" width="148px" formTitle="公约收养" defaultValue="">
										<BZ:option value="">--请选择--</BZ:option>
		...
		<div class="page-content">
			<div class="wrapper">
				...
				<div class="table-row table-btns" style="text-align: left">
					...
					<input type="button" value="登记预打印" class="btn btn-sm btn-primary" onclick="_prePrint()"/>&nbsp;
					<input type="button" value="申请书打印" class="btn btn-sm btn-primary" onclick="_appPrint()"/>&nbsp;
					<input type="button" value="收养登记" class="btn btn-sm btn-primary" onclick="_adoptionReg()"/>&nbsp;
					<input type="button" value="补&nbsp;&nbsp;打" class="btn btn-sm btn-primary" onclick="_suppPrint()"/>&nbsp;
					<input type="button" value="维&nbsp;&nbsp;护" class="btn btn-sm btn-primary" onclick="_mod()"/>&nbsp;
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="收养登记数据" exportCode="SEX=CODE,ETXB;IS_CONVENTION_ADOPT=FLAG,0:否&1:是;ADREG_STATE=FLAG,0:未登记&1:已登记&2:无效登记;BIRTHDAY=DATE;SIGN_DATE=DATE;ADREG_DATE=DATE,yyyy/MM/dd" exportField="COUNTRY_CN=国家,15,20;NAME_CN=收养组织,20;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;WELFARE_NAME_CN=福利院,20;CHILD_TYPE=儿童类型,15;NAME=姓名,15;SEX=性别,10;BIRTHDAY=出生日期,15;IS_CONVENTION_ADOPT=公约收养,10;SIGN_DATE=签批日期,15;ADREG_DATE=登记日期,15;ADREG_NO=登记证号,15;ADREG_STATE=登记状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

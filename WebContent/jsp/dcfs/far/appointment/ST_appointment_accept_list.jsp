 ...
 * @Description: 省厅预约申请受理列表
 * @author xugy
 * @date 2014-10-2下午2:56:34
 * @version V1.0   
 */
%>
				...
				<tr>
					<td style="width: 100%;">
						<table>
							...
							<tr>
								<td class="bz-search-title">预约时间</td>
								<td colspan="2">
									<BZ:input prefix="S_" field="ORDER_DATE_START" id="S_ORDER_DATE_START" type="DateTime" dateFormat="yyyy-MM-dd HH:mm" dateExtend="maxDate:'#F{$dp.$D(\\'S_ORDER_DATE_END\\')}',readonly:true" defaultValue="" formTitle="起始预约时间" />~
									<BZ:input prefix="S_" field="ORDER_DATE_END" id="S_ORDER_DATE_END" type="DateTime" dateFormat="yyyy-MM-dd HH:mm" dateExtend="minDate:'#F{$dp.$D(\\'S_ORDER_DATE_START\\')}',readonly:true" defaultValue="" formTitle="截止预约时间" />
								</td>
								<td class="bz-search-title">建议时间</td>
								<td colspan="2">
									<BZ:input prefix="S_" field="SUGGEST_DATE_START" id="S_SUGGEST_DATE_START" type="DateTime" dateFormat="yyyy-MM-dd HH:mm" dateExtend="maxDate:'#F{$dp.$D(\\'S_SUGGEST_DATE_END\\')}',readonly:true" defaultValue="" formTitle="起始建议时间" />~
									<BZ:input prefix="S_" field="SUGGEST_DATE_END" id="S_SUGGEST_DATE_END" type="DateTime" dateFormat="yyyy-MM-dd HH:mm" dateExtend="minDate:'#F{$dp.$D(\\'S_SUGGEST_DATE_START\\')}',readonly:true" defaultValue="" formTitle="截止建议时间" />
								</td>
							</tr>
							<tr>
								<td class="bz-search-title">预约状态</td>
								<td>
		...
		<div class="page-content">
			<div class="wrapper">
				...
				<div class="table-row table-btns" style="text-align: left">
					...
					<input type="button" value="受&nbsp;&nbsp;理" class="btn btn-sm btn-primary" onclick="_appointmentAccept()"/>&nbsp;
					...
					<table class="table table-striped table-bordered table-hover dataTable" adsorb="both" init="true" id="sample-table">
						<thead>
							<tr>
								...
								<th style="width: 8%;">
									<div class="sorting" id="ORDER_DATE">预约时间</div>
								</th>
								<th style="width: 8%;">
									<div class="sorting" id="SUGGEST_DATE">建议时间</div>
								</th>
								<th style="width: 5%;">
									<div class="sorting" id="ORDER_STATE">预约状态</div>
								</th>
						...
						<BZ:for property="List">
							<tr class="emptyData">
								...
								<td><BZ:data field="ORDER_STATE" defaultValue="" checkValue="0=未提交;1=待确认;2=通过;3=不通过;"/></td>
							</tr>
						</BZ:for>
						</tbody>
					</table>
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="登记预约数据" exportCode="SEX=CODE,ETXB;ORDER_STATE=FLAG,0:未提交&1:待确认&2:通过&3:不通过;BIRTHDAY=DATE,yyyy/MM/dd;ORDER_DATE=DATE;SUGGEST_DATE=DATE,yyyy-MM-dd HH:mm;" exportField="SIGN_NO=通知书号,15,20;COUNTRY_CN=国家,15;NAME_CN=收养组织,20;MALE_NAME=男方,15;FEMALE_NAME=女方,15;WELFARE_NAME_CN=福利院,20;NAME=姓名,15;SEX=性别,10;BIRTHDAY=出生日期,15;ORDER_DATE=预约时间,15;SUGGEST_DATE=建议时间,15;ORDER_STATE=预约状态,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

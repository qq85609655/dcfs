<%
/**   
 * @Title: SYZZ_appointment_mod.jsp
 * @Description: 收养组织预约申请修改
 * @author xugy
 * @date 2014-10-1上午10:51:23
 * @version V1.0   
 */
%>
...
function _save(ORDER_STATE){
	...
	document.srcForm.action=path+"appointment/saveSYZZAppointmentMod.action?ORDER_STATE="+ORDER_STATE;

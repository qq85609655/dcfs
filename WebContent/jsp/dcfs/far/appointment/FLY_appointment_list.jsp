		...
		<div class="page-content">
			<div class="wrapper">
				...
				<div class="table-row table-btns" style="text-align: left">
					...
					<input type="button" value="预约查看" class="btn btn-sm btn-primary" onclick="_show()"/>&nbsp;
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="登记预约数据" exportCode="SEX=CODE,ETXB;BIRTHDAY=DATE,yyyy/MM/dd;ORDER_DATE=DATE,yyyy-MM-dd HH:mm;" exportField="SIGN_NO=通知书号,15,20;COUNTRY_CN=国家,15;NAME_CN=收养组织,20;MALE_NAME=男方,15;FEMALE_NAME=女方,15;NAME=姓名,15;SEX=性别,10;BIRTHDAY=出生日期,15;ORDER_DATE=预约时间,15;"/></td>
						</tr>
					</table>
				</div>
				<!--分页功能区End -->

	...
	*/	
	...
	<BZ:form name="srcForm" method="post" token="<%=token %>">
        ...
        <div id="tab-container" class='tab-container'>
			<ul class='etabs'>
					<li class='tab' id="tb1"><a href="#tab7">中文</a></li>
					<li class='tab' id="tb2"><a href="#tab8">外文</a></li>
			</ul>
							...
							<td>
								...
								<table class="specialtable">
									...
									<tr>
										...
										<td class="edit-data-title">有效期限</td>
										<td class="edit-data-value">
											<BZ:select field="VALID_PERIOD_TYPE" id="tb_dqsy_en_VALID_PERIOD_TYPE" formTitle="" defaultValue="" notnull="" onchange="_chgValue(this,1,'VALID_PERIOD_TYPE')">
												<BZ:option value="1">有效期限</BZ:option>
												<BZ:option value="2">长期</BZ:option>
											</BZ:select>

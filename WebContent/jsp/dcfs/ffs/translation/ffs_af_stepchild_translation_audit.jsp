	...
	*/	
	...
	<BZ:form name="srcForm" method="post" token="<%=token %>">
        ...
        <div id="tab-container" class='tab-container'>
            <ul class='etabs'>
                <li class='tab'><a href="#tab7">中文</a></li>
                <li class='tab'><a href="#tab8">外文</a></li>
            </ul>
                            ...
                            <td>
                                ...
                                <table class="specialtable">                          	
                                    ...
                                    <tr>
                                        ...
                                        <td class="edit-data-value">
                                            <BZ:select field="VALID_PERIOD_TYPE" id="tb_jzn_cn_VALID_PERIOD_TYPE" formTitle="" defaultValue="" notnull="" onchange="_chgValue(this,0,'VALID_PERIOD_TYPE')">
									...
									<tr>
										...
										<input type="button" value="附件上传" onclick="_toipload('0')" />
										</td>
                                    </tr>
									<tr>
										<td colspan="5">
                            ...
                            <td>
                                ...
                                <table class="specialtable">                          	
                                    <tr>
                                        <td class="edit-data-title" width="15%">外文姓名</td>
                                        <td class="edit-data-value" width="26%">
                                            <BZ:input field="MALE_NAME" id="tb_jzn_en_MALE_NAME" formTitle="" defaultValue="" notnull=""  maxlength="150" size="30" onchange="_chgValue(this,1,'MALE_NAME')"/>
                                        </td>
                                        <td class="edit-data-title" width="15%">性别</td>
                                        <td class="edit-data-value" width="26%">
                                            <BZ:select field="ADOPTER_SEX" id="tb_jzn_en_ADOPTER_SEX" formTitle="" defaultValue="" notnull="" width="210px" onchange="_chgValue(this,1,'ADOPTER_SEX')">
												<BZ:option value="">--请选择--</BZ:option>
                                                <BZ:option value="1">男</BZ:option>
                                                <BZ:option value="2">女</BZ:option>
                                            </BZ:select>					
                                    ...
                                    <tr>
                                        <td class="edit-data-title">出生日期</td>
                                        <td class="edit-data-value">
                                            <BZ:input field="MALE_BIRTHDAY" id="tb_jzn_en_MALE_BIRTHDAY" formTitle="" defaultValue="" type="Date" dateExtend="maxDate:'%y-%M-%d'" notnull="" onchange="_chgBirthday(this,1,'MALE_BIRTHDAY','1')"/>
                                        </td>
                                        <td class="edit-data-title">年龄</td>
                                        <td class="edit-data-value">
                                    ...
                                    <tr>
                                        ...
                                        <td class="edit-data-title">有效期限</td>
                                        <td class="edit-data-value">
                                            <BZ:select field="VALID_PERIOD_TYPE" id="tb_jzn_en_VALID_PERIOD_TYPE" formTitle="" defaultValue="" notnull="" onchange="_chgValue(this,1,'VALID_PERIOD_TYPE')">
                                                <BZ:option value="1">有效期限</BZ:option>
                                                <BZ:option value="2">长期</BZ:option>
                                            </BZ:select>
									...
									<tr>
										...
										<b>附件信息</b></td>
										<td class="edit-data-title" colspan="1" style="text-align:center">
										<input type="button" value="附件上传" onclick="_toipload('1')" />
										</td>
                                    </tr>
									<tr>
										<td colspan="5">

...
function _showSearch(){
  	...
  	function _audit(){
		...
		if(num != "1"){
			...
			if(aud_state == "0" || aud_state == "1" || aud_state == "9"){
				document.srcForm.action=path+"ffs/jbraudit/toAuditForOneLevel.action?FLAG=cf&AF_ID="+af_id+"&AU_ID="+au_id;
				document.srcForm.submit();
			}else if(aud_state == "2"){
				document.srcForm.action=path+"ffs/jbraudit/toAuditForTwoLevel.action?FLAG=cf&AF_ID="+af_id+"&AU_ID="+au_id;
				document.srcForm.submit();
			}else if(aud_state == "3"){
				document.srcForm.action=path+"ffs/jbraudit/toAuditForThreeLevel.action?FLAG=cf&AF_ID="+af_id+"&AU_ID="+au_id;
				document.srcForm.submit();
			}else if(aud_state == "4"){
  ...
  <BZ:body property="data" codeNames="WJLX;GJSY;SYZZ;WJLX_DL;FYDW">
     ...
     <input type="hidden" name="S_COUNTRY_CODE" id="S_COUNTRY_CODE" value="<%=COUNTRY_CODE%>" />
				...
				<td style="width: 100%;">
					<table>
						  <tr>
							...
							<td style="width: 18%">
								<BZ:select field="COUNTRY_CODE" formTitle="" prefix="S_" isCode="true" codeName="GJSY" width="148px" onchange="_findSyzzNameListForNew('S_COUNTRY_CODE','S_ADOPT_ORG_ID','S_HIDDEN_ADOPT_ORG_ID')">
									<option value="">--请选择--</option>
								</BZ:select>
							</td>
							<td class="bz-search-title" style="width: 10%">
		     ...
		     <div class="wrapper">     
				...
				<div class="footer-frame">
					<table border="0" cellpadding="0" cellspacing="0" class="operation">
						<tr>
							<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="重翻文件信息"

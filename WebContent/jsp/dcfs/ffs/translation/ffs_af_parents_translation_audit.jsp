                                ...
                                <table class="specialtable">                          	
                                    ...
                                    <tr>
                                        ...
                                        <td class="edit-data-value" colspan="2">
                                            ...
                                            <span id="tb_sqsy_cn_FEMALE_HEIGHT_METRE"><BZ:input field="FEMALE_HEIGHT" id="tb_sqsy_cn_FEMALE_HEIGHT" formTitle="" defaultValue="" restriction="int" maxlength="" onchange="_chgHeight(this,0,'FEMALE_HEIGHT','2')"  size="36"/>厘米</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="edit-data-value">
                                            <BZ:select field="VALID_PERIOD_TYPE" id="tb_sqsy_cn_VALID_PERIOD_TYPE" formTitle="" defaultValue="" notnull="" onchange="_chgValue(this,0,'VALID_PERIOD_TYPE')">
                                                ...
                                                <BZ:option value="-1">长期</BZ:option>
                                            </BZ:select>

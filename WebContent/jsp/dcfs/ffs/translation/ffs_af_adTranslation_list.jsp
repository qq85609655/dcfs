...
//文件翻译
  function _translation(){
	...
	//	return;
		 ...
		 document.srcForm.action=path+"/ffs/ffsaftranslation/adTranslation.action?UUID="+showuuid;
		 document.srcForm.submit();
	 }
  } 
	...
	<!-- 功能按钮操作区End -->
		...
		<div class="footer-frame">
			<table border="0" cellpadding="0" cellspacing="0" class="operation">
				<tr>
					<td><BZ:page form="srcForm" property="List" exportXls="true" exportTitle="文件补翻列表" 
					...
					exportField="FILE_NO=收文编号,15,20;REGISTER_DATE=收文日期,10;FILE_TYPE=文件类型,10;COUNTRY_CN=国家,10;NAME_CN=收养机构,25;MALE_NAME=男收养人,15;FEMALE_NAME=女收养人,15;NOTICE_DATE=补翻日期,10;COMPLETE_DATE=完成日期,10;TRANSLATION_UNITNAME=翻译单位,15;TRANSLATION_STATE=翻译状态,10;"/></td>				
				</tr>
			</table>
		</div>
		<!--分页功能区End -->

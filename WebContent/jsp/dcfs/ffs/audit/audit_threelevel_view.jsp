			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="ACCEPTED_CARD" onlyValue="true" defaultValue='' checkValue="1=齐全;2=不齐全" />					
							
						</td>
						<td class="bz-edit-data-title">复核结果</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_OPTION" onlyValue="true" defaultValue='' codeName="WJFGZRSP"/>	
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-title">复核日期</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_DATE" onlyValue="true" defaultValue='' type="Date"/>				
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="IS_WARNING" onlyValue="true" defaultValue='' checkValue="0=否;1=是"/>
						</td>
						...
						<td class="bz-edit-data-value" id="twArea2" style="display:none">
							<BZ:dataValue field="HANDLE_TYPE" onlyValue="true" defaultValue='' codeName="TWCZFS_ALL" />
						</td>
					</tr>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="MALE_NAME"  onlyValue="true"/>	
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="FEMALE_NAME"  onlyValue="true"/>				
						</td>

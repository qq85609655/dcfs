			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
				    		<BZ:dataValue field="ACCEPTED_CARD" defaultValue="" onlyValue="true" checkValue="1=齐全;2=不齐全"  />
						</td>
						<td class="bz-edit-data-title">翻译单位</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="TRANSLATION_COMPANY" defaultValue="" onlyValue="true" checkValue="9151=爱之桥;9221=北翻"  />
						</td>
						<td class="bz-edit-data-title">翻译质量</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="TRANSLATION_QUALITY" defaultValue="" onlyValue="true" checkValue="1=合格;2=不合格"  />
						</td>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
				    		<BZ:dataValue field="IS_MODIFY" defaultValue="" onlyValue="true" checkValue="0=否;1=是"/>
						</td>
						<td class="bz-edit-data-title">是否允许补充附件</td>
						<td class="bz-edit-data-value">
				    		<BZ:dataValue field="NOTICE_DATE" defaultValue="" onlyValue="true" checkValue="0=否;1=是"/>	
						</td>

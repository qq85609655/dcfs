...
<script type="text/javascript">	
    ...
    function _goback(){
    	...
    	if(flag == "bf"){
    		...
    		window.location.href=path+"ffs/jbraudit/findListForTwoLevel.action";
    	}
    }
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						<td class="bz-edit-data-title"><font color="red">*</font>复核结果</td>
						<td class="bz-edit-data-value">
							<BZ:select field="AUDIT_OPTION" formTitle="复核结果" prefix="AUD_" id="AUD_AUDIT_OPTION" codeName="WJBMZRFH" isCode="true" notnull="请选择复核结果" onchange="_dyGetContent();_dyShowArea();">

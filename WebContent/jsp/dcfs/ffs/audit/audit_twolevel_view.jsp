...
<BZ:body property="returnData" codeNames="GJSY;SYZZ;SYS_ADOPT_ORG_ALL;SYLX;WJLX;WJBMZRFH;TWCZFS_ALL">
<script type="text/javascript">	
	$(document).ready(function() {
		$('#tab-container').easytabs();
		_dyShowYjArea();
    ...
    function _save(){
    	//页面表单校验
		if (!runFormVerify(document.srcFormForTwoLevel, false)) {
			return;
		}
		getIframeFileInfo();
 		document.srcFormForTwoLevel.action=path+"ffs/jbraudit/saveForTwoLevel.action?FLAG=<%=flag %>";
 		document.srcFormForTwoLevel.submit();
    }
    ...
    function _submit(){
		...
		getIframeFileInfo();
	 	document.srcFormForTwoLevel.action=path+"ffs/jbraudit/submitForTwoLevel.action";
	 	document.srcFormForTwoLevel.submit();
	...
	function _dyGetContent(){
		...
		if(null!=audit_option&&""!=audit_option){
			$.ajax({
				url: path+'AjaxExecute?className=com.dcfs.ffs.audit.OpinionTemAjax&method=getAuditModelContent&TYPE=00&AUDIT_TYPE=1&AUDIT_OPTION='+audit_option+'&GY_TYPE='+gy_type,
				type: 'POST',
				timeout:1000,
				dataType: 'json',
	...
	<BZ:form name="srcFormForTwoLevel" method="post" token="<%=token %>" >
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="ACCEPTED_CARD" onlyValue="true" defaultValue="" />	
						</td>
						<td class="bz-edit-data-title">复核结果</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_OPTION" onlyValue="true" codeName="WJBMZRFH" defaultValue=""/>					
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value" colspan="3">
							<BZ:dataValue field="AUDIT_CONTENT_CN"  onlyValue="true"  defaultValue=""/>	
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">复核人</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_USERNAME"  onlyValue="true"  defaultValue=""/>					
						</td>
						<td class="bz-edit-data-title">复核日期</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_DATE"  onlyValue="true"  defaultValue=""/>						
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value" colspan="3">
							<BZ:dataValue field="AUDIT_REMARKS"  onlyValue="true"  defaultValue=""/>		
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">是否加入预警名单</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="AUDIT_REMARKS"  onlyValue="true" checkValue="0=否;1=是" defaultValue=""/>		
						</td>
						...
						<td class="bz-edit-data-value" id="twArea2" style="display:none">
							<BZ:dataValue field="HANDLE_TYPE"  onlyValue="true" codeName="TWCZFS_ALL" defaultValue=""/>	
						</td>
					</tr>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="MALE_BIRTHDAY"  onlyValue="true"  type="date" defaultValue=""/>	
						</td>
					</tr>
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="FEMALE_BIRTHDAY"onlyValue="true"  type="date" defaultValue=""/>						
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">国家</td>
						<td class="bz-edit-data-value" >
							<BZ:dataValue field="COUNTRY_CODE" codeName="GJSY"  onlyValue="true" defaultValue=""/>			
						</td>
						<td class="bz-edit-data-title">收养组织</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="ADOPT_ORG_ID" codeName="SYS_ADOPT_ORG_ALL"   onlyValue="true" defaultValue=""/>
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">加入预警名单原因</td>
						<td class="bz-edit-data-value" colspan="5">
							<BZ:dataValue field="WARNING_CONTENT"  onlyValue="true"  defaultValue=""/>
						</td>

<%
/**   
 * @Title: normalFile_doubletempleteview.jsp
 * @Description:  收养组织递交普通文件双亲收养查看页面
 * @author yangrt   
...
<BZ:body property="data" codeNames="ZCWJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;SGYJ;">
	<!-- 隐藏区域begin -->
				...
				<table class="bz-edit-data-table table-print" border="0">
					<tr>
						...
						<td class="bz-edit-data-value" colspan="3">
							<BZ:dataValue field="NAME_CN" hrefTitle="收养组织(CN)" isShowEN="true" defaultValue="" />
						</td>
					</tr>
					<tr>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table table-print" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value" colspan="2">
							<BZ:dataValue field="MALE_MARRY_TIMES" defaultValue=""/><span class="MARRY_TIMES" style="display: none;">次(Times)</span>
						</td>
						<td class="bz-edit-data-value" colspan="2">
							<BZ:dataValue field="FEMALE_MARRY_TIMES" defaultValue=""/><span class="MARRY_TIMES" style="display: none;">次(Times)</span>
						</td>
					</tr>
				</table>
				...
				<table class="bz-edit-data-table table-print" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="CURRENCY" codeName="HBBZ" isShowEN="true" defaultValue=""/>
						</td>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table table-print" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-title">心理评估报告<br>Psychological assessmen</td>
						<td class="bz-edit-data-value">
						...
						<td class="bz-edit-data-value" width="19%">
							<BZ:dataValue field="ADOPT_MOTIVATION" defaultValue="" codeName="ADOPTER_ADOPT_MOTIVATION" isShowEN="true"/>
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">家中10周岁及以上孩子对收养的意见<br>Opinion of adoption by children in the family over age 10</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="CHILDREN_ABOVE" defaultValue="" codeName="ADOPTER_CHILDREN_ABOVE" isShowEN="true"/>
						</td>
						<td class="bz-edit-data-title">有无指定监护人<br>Any designated guardian</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="IS_FORMULATE" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title" width="15%">不遗弃不虐待声明<br>Statement of no abandonment and no abuse</td>
						<td class="bz-edit-data-value" width="19%">
							<BZ:dataValue field="IS_ABUSE_ABANDON" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">抚育计划<br>Care plan </td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="IS_MEDICALRECOVERY" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title">收养前准备<br>Pre-adoption preparation</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="ADOPT_PREPARE" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title">风险意识<br>Risk awareness</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="RISK_AWARENESS" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
					</tr>
					<tr>
						<td class="bz-edit-data-title">同意递交安置后报告声明<br>Statement of consent for post-placement reports</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="IS_SUBMIT_REPORT" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title">家中有无其他人同住<br>Anyone else living with the family</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="IS_FAMILY_OTHERS_FLAG" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="PARENTING" checkValue="0=No;1=Yes;" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title">社工意见<br>Conclusion of social worker</td>
						<td class="bz-edit-data-value">
							<BZ:dataValue field="SOCIALWORKER" codeName="SGYJ" isShowEN="true" defaultValue=""/>
						</td>

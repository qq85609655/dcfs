<%
/**   
 * @Title: normalFile_doubletempleteadd.jsp
...
<BZ:html>
	...
	<script>
		...
		function _toipload(fn,obj){
			...
			popWin.showWinIframe("1000","542","fileframe","Upload attachment","iframe","#",y);
	...
	<BZ:body property="data" codeNames="GJ;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;SGYJ;">
						...
						<table class="bz-edit-data-table" border="0">
							...
							<tr>
								...
								<td class="bz-edit-data-value" colspan="2">
									<BZ:input prefix="R_" field="MALE_NAME" id="R_MALE_NAME" formTitle="Name(Male)" defaultValue="" notnull="Please write the name of adoptive father!" maxlength="150"/>
								</td>
								<td class="bz-edit-data-value" colspan="2">
									<BZ:input prefix="R_" field="FEMALE_NAME" id="R_FEMALE_NAME" formTitle="Name(Female)" defaultValue="" notnull="Please write the name of adoptive mother!" maxlength="150"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="bz-edit-data-value" colspan="2">
									<BZ:select prefix="R_" field="MALE_PUNISHMENT_FLAG" formTitle="" defaultValue="" width="30%" notnull="" onchange="_setMalePunishment(this)">
										<BZ:option value="">--Please select--</BZ:option>
								...
								<td class="bz-edit-data-value" colspan="2">
									<BZ:select prefix="R_" field="FEMALE_PUNISHMENT_FLAG" formTitle="" defaultValue="" width="30%" notnull="" onchange="_setFemalePunishment(this)">
										<BZ:option value="">--Please select--</BZ:option>
										<BZ:option value="0">No</BZ:option>
										<BZ:option value="1">Yes</BZ:option>
									</BZ:select>
							...
							<tr>
								...
								<td class="bz-edit-data-value" colspan="2">
									<BZ:select prefix="R_" field="MALE_ILLEGALACT_FLAG" formTitle="" defaultValue="" width="30%" notnull="" onchange="_setMaleIllegalact(this)">
										<BZ:option value="">--Please select--</BZ:option>
										<BZ:option value="0">No</BZ:option>
										<BZ:option value="1">Yes</BZ:option>
									</BZ:select>
								...
								<td class="bz-edit-data-value" colspan="2">
									<BZ:select prefix="R_" field="FEMALE_ILLEGALACT_FLAG" formTitle="" defaultValue="" width="30%" notnull="" onchange="_setFemaleIllegalact(this)">
										<BZ:option value="">--Please select--</BZ:option>
										<BZ:option value="0">No</BZ:option>
										<BZ:option value="1">Yes</BZ:option>
									</BZ:select>

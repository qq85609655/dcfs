<%
/**   
 * @Title: specialFile_doubletempleteadd.jsp
 * @Description:  双亲收养文件详细信息添加页
 * @author yangrt   
...
<BZ:html>
	...
	<script>
		$(document).ready(function() {
			...
			var org_name = $("#R_HOMESTUDY_ORG_NAME").val();
			if(country_code == "21"){	//21:美国
				...
				if(isShowOrgName == "true"){
					...
					//当前组织所属国家为美国时，完成家调组织名称为下拉框显示
					$("#R_HOMESTUDY_ORG_DROP").show();
					$("#R_HOMESTUDY_ORG_DROP").val(org_name);
					$("#R_HOMESTUDY_ORG_DROP").attr("notnull","Please select the adoption agency of completion for home study!");
				...
				$("#R_HOMESTUDY_ORG_INPUT").show();
				$("#R_HOMESTUDY_ORG_INPUT").val(org_name);
				$("#R_HOMESTUDY_ORG_INPUT").attr("notnull","Please write the adoption agency of completion for home study!");
		...
		function _setHeightWeight(){
			...
			if(typeval == "1"){	//当选择英制时
				...
				var male_height = $("#R_MALE_HEIGHT").val();	//男收养人公制身高ccc
				var female_height = $("#R_FEMALE_HEIGHT").val();	//女收养人公制身高
				if(male_height == ""){
	...
	<BZ:body property="data" codeNames="GJ;SYLX;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;BCZL;SGYJ;PROVINCE;ETXB;">
		...
		<div class="bz-edit-data-content clearfix" desc="内容体" style="width: 98%;margin-left:auto;margin-right:auto;">
			<div class="stepflex" style="margin-right: 30px;">
		        <dl id="payStepFrist" class="first done">
		            <dt class="s-num">1</dt>
		            <dd class="s-text" style="margin-left: 3px;">第一步：选择预批文件(Step 1: Choose an application for pre-approval)</dd>
		        </dl>
		        <dl id="payStepNormal" class="last doing">
		            <dt class="s-num">2</dt>
		            <dd class="s-text" style="margin-left: 3px;">第二步：录入详细信息(Step 2: Input detailed information)<s></s>
		                <b></b>
		            </dd>
		        </dl>
			</div>
						...
						<table class="bz-edit-data-table" border="0">
							...
							<tr>
								...
								<td class="bz-edit-data-value" width="30%">
									<BZ:dataValue field="FAMILY_TYPE" defaultValue="" codeName="SYLX" isShowEN="true" onlyValue=""/>
								</td>
							</tr>
						</table>
					</div>
					...
					<div class="bz-edit-data-content clearfix" desc="内容体">
						<table class="bz-edit-data-table" border="0">
							...
							<tr>
								...
								<td class="bz-edit-data-value" colspan="2">
									...
									<BZ:input prefix="R_" field="MALE_HEALTH_CONTENT_EN" id="R_MALE_HEALTH_CONTENT_EN" formTitle="" type="textarea" defaultValue="" maxlength="1000" style="display:none" style="width:60%;"/>
								</td>
								<td class="bz-edit-data-value" colspan="2">
									...
									<BZ:input prefix="R_" field="FEMALE_HEALTH_CONTENT_EN" id="R_FEMALE_HEALTH_CONTENT_EN" formTitle="" type="textarea" defaultValue="" maxlength="1000" style="display:none" style="width:60%;"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="bz-edit-data-value" colspan="2">
									<span id="MALE_BMI_SHOW"><BZ:dataValue field="MALE_BMI" defaultValue="" onlyValue="true"/></span>
								</td>
								<td class="bz-edit-data-value" colspan="2">
									<span id="FEMALE_BMI_SHOW"><BZ:dataValue field="FEMALE_BMI" defaultValue="" onlyValue="true"/></span>
								</td>
							</tr>
							<tr>
						...
						<table class="bz-edit-data-table" border="0">
							...
							<tr>
								...
								<td class="bz-edit-data-value">
									<BZ:select prefix="R_" field="CURRENCY" id="R_CURRENCY" formTitle="" defaultValue="" isCode="true" codeName="HBBZ" isShowEN="true" notnull="Please write the Currency Unit!" width="76%">
										<BZ:option value="">--Please select--</BZ:option>
									</BZ:select>
								</td>
					...
					<div class="bz-edit-data-content clearfix" desc="内容体">
						<table class="bz-edit-data-table" border="0">
							<tr>
								...
								<td class="bz-edit-data-value" width="18%">
									<BZ:select prefix="R_" field="HOMESTUDY_ORG_DROP" id="R_HOMESTUDY_ORG_DROP" formTitle="" defaultValue="" isCode="true" codeName="ORGCOA_LIST" onchange="_setOrgNameDrop()" width="70%">
										<BZ:option value="">--Please select--</BZ:option>
									</BZ:select>
								...
								<td class="bz-edit-data-value" width="18%">
									<BZ:input prefix="R_" field="FINISH_DATE" id="R_FINISH_DATE" formTitle="" dateExtend="lang:'en'" defaultValue="" type="Date" notnull="Please select the date of completion for home study!"/>
								</td>
							...
							<tr>
								...
								<td class="bz-edit-data-value">
									<BZ:input prefix="R_" field="RECOMMENDATION_NUM" id="R_RECOMMENDATION_NUM" formTitle="" defaultValue="" restriction="int" notnull="Please write the number of recommendation letter!" style="width:60%" onblur="_checkLetterValue(this);"/>封(Number of letter)
								</td>
							...
							<tr>
								<td class="bz-edit-data-title"><font color="red">*</font>育儿经验<br>Parenting experienc</td>
								<td class="bz-edit-data-value">

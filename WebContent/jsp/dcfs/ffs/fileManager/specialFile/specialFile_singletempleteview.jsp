<%
/**   
 * @Title: specialFile_singletempleteview.jsp
 * @Description:  收养组织递交特需文件单亲收养查看页面
 * @author yangrt   
...
<BZ:body property="data" codeNames="WJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_MARRYCOND;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;BCZL;SGYJ;PROVINCE;">
	<!-- 隐藏区域begin -->
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0" id="maleshow">
					<tr>
						<td class="bz-edit-data-title" width="15%">外文姓名<br>Name</td>
						<td class="bz-edit-data-value table-print" width="18%">
				...
				<table class="bz-edit-data-table table-print" border="0">
					<tr>
						<td class="bz-9dit-data-title" width="15%">宗教信仰<br>Religious belief</td>
						<td class="bz-edit-data-value" width="18%">
				...
				%>
					<tr>
						...
						<td class="bz-edit-data-value" width="15%">
							<BZ:dataValue field="PROVINCE_ID" property="childData" codeName="PROVINCE" isShowEN="true" defaultValue="" onlyValue="true"/>
						</td>

<%
/**   
 * @Title: specialFile_doubletempleteview.jsp
 * @Description:  收养组织递交特需文件双亲收养查看页面
 * @author yangrt   
...
<BZ:body property="data" codeNames="WJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;BCZL;SGYJ;PROVINCE;">
	<!-- 隐藏区域begin -->
				...
				%>
					<tr>
						...
						<td class="bz-edit-data-value" width="15%">
							<BZ:dataValue field="PROVINCE_ID" codeName="PROVINCE" isShowEN="true" property="childData" defaultValue=""/>
						</td>
						...
						<td class="bz-edit-data-value" width="15%">
							<BZ:dataValue field="NAME_PINYIN" property="childData" defaultValue=""/>
						</td>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="SEX" property="childData" codeName="ADOPTER_CHILDREN_SEX" isShowEN="true" defaultValue="" onlyValue="true"/>
						</td>

<%
/**   
 * @Title: adoptionpersoninfoCN_stepview.jsp
				...
				<div class="bz-edit-data-content clearfix" desc="内容体">
					<table class="bz-edit-data-table" border="0">
						<tr>
							...
							<td class="bz-edit-data-value" width="25%">
								<BZ:dataValue field="ADOPTER_SEX" checkValue="1=男;2=女;" defaultValue="" onlyValue="true"/>
							</td>
						...
						<tr>
							...
							<td class="bz-edit-data-value">
								<span class="male"><BZ:dataValue field="MALE_NATION" defaultValue="" codeName="GJ" onlyValue="true"/></span>
								<span class="female"><BZ:dataValue field="FEMALE_NATION" defaultValue="" codeName="GJ" onlyValue="true"/></span>
							</td>

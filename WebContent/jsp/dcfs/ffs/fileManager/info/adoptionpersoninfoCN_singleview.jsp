<%
/**   
 * @Title: adoptionpersoninfoCN_singleview.jsp
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				<table class="bz-edit-data-table" border="0">
					<tr>
						...
						<td class="bz-edit-data-value" width="18%">
							<span id="femalereligionshow"><BZ:dataValue field="FEMALE_RELIGION_CN" defaultValue="" onlyValue="true"/></span>
							<span id="malereligionshow"><BZ:dataValue field="MALE_RELIGION_CN" defaultValue="" onlyValue="true"/></span>
						</td>
		...
		<div class="ui-widget-content ui-corner-all bz-edit-warper">
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table" border="0">
					<tr>
						<td class="bz-edit-data-value">
							<IFRAME ID="frmUpload" SRC="<%=path%>/common/batchattmaintain.action?bigType=AF&packID=<%=AttConstants.AF_SIGNALPARENT%>&packageID=<%=af_id %>" frameborder=0 width="100%" ></IFRAME>
						</td>
					</tr>
				</table>
			</div>

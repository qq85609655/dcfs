<%
/**   
 * @Title: fileDetail_singleview.jsp
				...
				<div class="bz-edit-data-content clearfix" desc="内容体">
					...
					<table class="bz-edit-data-table" border="0">
						<tr>
							...
							<td class="bz-edit-data-value">
								<span id="femalereligionshow"><BZ:dataValue field="FEMALE_RELIGION_EN" defaultValue=""/></span>
								<span id="malereligionshow"><BZ:dataValue field="MALE_RELIGION_EN" defaultValue=""/></span>
							</td>
							...
							<td class="bz-edit-data-title">同居伙伴<br>Cohabitant partner</td>
								<td class="bz-edit-data-value">
									<BZ:dataValue field="CONABITA_PARTNERS" checkValue="0=No;1=Yes;" defaultValue=""/>
								</td>
							</tr>
							<tr>
								<td class="bz-edit-data-title">同居时长<br>Cohabitation period</td>
								<td class="bz-edit-data-value">
									<BZ:dataValue field="CONABITA_PARTNERS_TIME" defaultValue=""/>年(Year)
								</td>
								<td class="bz-edit-data-title">非同性恋声明<br>Non-Homosexual statement</td>
								<td class="bz-edit-data-value">
									<BZ:dataValue field="GAY_STATEMENT" checkValue="0=No;1=Yes;" defaultValue=""/>
								</td>
								<td class="bz-edit-data-title">货币单位<br>Currency</td>
								<td class="bz-edit-data-value">
									<BZ:dataValue field="CURRENCY" defaultValue="" codeName="HBBZ" isShowEN="true"/>
								</td>
							</tr>
							<tr>
					...
					<table class="bz-edit-data-table" border="0">
						<tr>
							...
							<td class="bz-edit-data-value" width="19%">
								<BZ:dataValue field="INTERVIEW_TIMES" defaultValue=""/>次(Times)
							</td>
						</tr>
						<tr>
							<td class="bz-edit-data-title">推荐信<br>Recommendation letter</td>
							<td class="bz-edit-data-value">
								<BZ:dataValue field="RECOMMENDATION_NUM" defaultValue=""/>封(Number of letter)
							</td>
						...
						<tr>
							<td class="bz-edit-data-title">家庭需说明的其他事项<br>Other issues requiring clarification from the adopti</td>
							<td class="bz-edit-data-value" colspan="5">
				...
				<div class="bz-edit-data-content clearfix" desc="内容体">
					<table class="bz-edit-data-table" border="0">
						<tr>
							...
							<td class="bz-edit-data-title" width="15%">批准儿童数量<br>Number of children approved</td>
							<td class="bz-edit-data-value" width="19%">
								<BZ:dataValue field="APPROVE_CHILD_NUM" defaultValue=""/> 个
							</td>
						</tr>
						<tr>

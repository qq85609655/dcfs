<%
/**   
 * @Title: suppleFile_stepview.jsp
 * @Description:  继子女收养文件信息查看页
 * @author yangrt   
...
<BZ:html>
	...
	<BZ:body property="data" codeNames="GJ;WJLX;SYLX">
		<!-- 隐藏区域begin -->
					...
					<table class="bz-edit-data-table table-print" border="0">
						<tr>
							...
							<td class="bz-edit-data-value" colspan="3">
								<BZ:dataValue field="NAME_CN" hrefTitle="Agency(CN)" defaultValue="" />
							</td>
						</tr>
						<tr>
							<td class="bz-edit-data-title" width="20%">收养组织(EN)<br>Agency(EN)</td>
							<td class="bz-edit-data-value" colspan="3">
								<BZ:dataValue field="NAME_EN" hrefTitle="Agency(EN)" defaultValue="" />
							</td>
						</tr>
						<tr>
							<td class="bz-edit-data-title" width="20%">文件类型<br>Document type</td>
							<td class="bz-edit-data-value" width="30%">
								<BZ:dataValue field="FILE_TYPE" codeName="WJLX" isShowEN="true" defaultValue=""/>
							</td>

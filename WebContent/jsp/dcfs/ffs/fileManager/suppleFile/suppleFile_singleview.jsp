<%
/**   
 * @Title: suppleFile_singleview.jsp
 * @Description:  单亲收养文件查看页面
 * @author yangrt   
 * @date 2014-8-26 14:03:34 
 * @version V1.0   
 */
%>
...
<BZ:body property="data" codeNames="WJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;ADOPTER_MARRYCOND;ADOPTER_CHILDREN_SEX;ADOPTER_CHILDREN_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_ABOVE;ORG_LIST;ETXB;BCZL;SGYJ;">
	<!-- 隐藏区域begin -->
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				<table class="bz-edit-data-table table-print" border="0">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="MARRY_CONDITION" codeName="ADOPTER_MARRYCOND" isShowEN="true" defaultValue="" onlyValue="true"/>
						</td>
			...
			<div class="bz-edit-data-content clearfix" desc="内容体">
				...
				%>
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="SEX" property="childData" codeName="ETXB" isShowEN="true" defaultValue=""/>
						</td>
						<td class="bz-edit-data-title">出生日期<br>D.O.B</td>
						<td class="bz-edit-data-value">
					...
					<tr>
						...
						<td class="bz-edit-data-value">
							<BZ:dataValue field="SN_TYPE" property="childData" defaultValue="" codeName="BCZL" isShowEN="true"/>
						</td>

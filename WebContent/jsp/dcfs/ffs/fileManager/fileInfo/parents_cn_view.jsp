...
<BZ:body property="data" codeNames="WJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_CHILDREN_ABOVE;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_MARRYCOND;SGYJ" style="width:100%">
	<!--双亲收养：start-->                            	  
	<table class="specialtable" style="width: 100%;">
		<tr style="width:100%;" >
			...
			<td>
				<table class="specialtable">
					...
					<tr>
						...
						<td class="edit-data-value" colspan="2">
							...
							<span id="FE_MALE_HEALTH_CONTENT_CN">
						...
						<td class="edit-data-value" colspan="2">
							...
							<span id="FE_FEMALE_HEALTH_CONTENT_CN">
					...
					<tr>
						...
						<td class="edit-data-value" colspan="2">
							...
							<span id="FE_MALE_PUNISHMENT_CN">
							<BZ:dataValue field="MALE_PUNISHMENT_CN" onlyValue="true" defaultValue=""/>
							</span>	
						</td>
						<td class="edit-data-value" colspan="2">
							<BZ:dataValue field="FEMALE_PUNISHMENT_FLAG" onlyValue="true" defaultValue="" checkValue="0=无;1=有"/>	
							<span id="FE_FEMALE_PUNISHMENT_CN">
							<BZ:dataValue field="FEMALE_PUNISHMENT_CN" onlyValue="true" defaultValue=""/>
							</span>	
						</td>
					</tr>
					<tr>
						...
						<td class="edit-data-value" colspan="2">
							...
							<span id="FE_MALE_ILLEGALACT_CN">
							<BZ:dataValue field="MALE_ILLEGALACT_CN" onlyValue="true" defaultValue=""/>
							</span>	
						</td>
						<td class="edit-data-value" colspan="2">
							<BZ:dataValue field="FEMALE_ILLEGALACT_FLAG" onlyValue="true" defaultValue="" checkValue="0=无;1=有"/>	
							<span id="FE_FEMALE_ILLEGALACT_CN">
							<BZ:dataValue field="FEMALE_ILLEGALACT_CN" onlyValue="true" defaultValue=""/>
							</span>
						</td>
					</tr>
					<tr>
				...
				<table class="specialtable">
					...
					<tr>
						...
						<td class="edit-data-value" colspan="5">
							<BZ:dataValue field="REMARK_CN" defaultValue="" onlyValue="true"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="6">
						<IFRAME ID="frmUpload" SRC="<%=path%>/common/batchattmaintain.action?bigType=AF&packID=<%=AttConstants.AF_PARENTS%>&packageID=<BZ:dataValue field="PACKAGE_ID_CN" onlyValue="true"/>" frameborder=0 width="100%" ></IFRAME> 
						</td>
					</tr>					
				</table>
			</td>

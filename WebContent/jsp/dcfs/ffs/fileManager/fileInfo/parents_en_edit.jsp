<%
/**   
 * @Title: parents_en_edit.jsp
 * @Description:  双亲收养文件_原文_编辑
 * @author wangzheng   
 * @date 2014-10-27
 * @version V1.0   
 */
				...
				<td>
					<table class="specialtable">
						...
						<tr>
							...
							<td class="edit-data-value" colspan="2">
								<BZ:input field="MALE_JOB_EN" prefix="FE_" formTitle="男收养人职业" defaultValue=""  id="FE_MALE_JOB_EN" size="36"/>
							</td>
							<td class="edit-data-value" colspan="2">
								<BZ:input field="FEMALE_JOB_EN" prefix="FE_" formTitle="女收养人职业" defaultValue="" id="FE_FEMALE_JOB_EN" size="36"/>
							</td>
						</tr>
						<tr>
							...
							<td class="edit-data-value" colspan="2">
								...
								<textarea style="dispaly:none;height: 40px;width: 90%;" name="FE_MALE_HEALTH_CONTENT_EN" id="FE_MALE_HEALTH_CONTENT_EN"><BZ:dataValue field="MALE_HEALTH_CONTENT_EN" onlyValue="true" defaultValue=""/></textarea>								
							</td>
							<td class="edit-data-value" colspan="2">
								...
								<textarea style="dispaly:none;height: 40px;width: 90%;" name="FE_FEMALE_HEALTH_CONTENT_EN" id="FE_FEMALE_HEALTH_CONTENT_EN"><BZ:dataValue field="FEMALE_HEALTH_CONTENT_EN" onlyValue="true" defaultValue=""/></textarea>
							</td>
						</tr>
						 <tr>
							...
							<td class="edit-data-value" colspan="2">								
								...
								<span id="tb_sqsy_en_MALE_HEIGHT_METRE"-->
								<BZ:input field="MALE_HEIGHT" id="FE_MALE_HEIGHT"  defaultValue="" restriction="number" maxlength="10" size="36" onchange="_setBMI('1')"/>厘米
							</td>
							<td class="edit-data-value" colspan="2">
								...
								<span id="tb_sqsy_en_FEMALE_HEIGHT_METRE"-->
						...
						<tr>
							...
							<td class="edit-data-value" colspan="2">
								...
								<BZ:input prefix="FE_" field="MALE_PUNISHMENT_EN" id="FE_MALE_PUNISHMENT_EN" defaultValue="" type="textarea" maxlength="1000" style="display:none;width:70%"/>
							</td>
							<td class="edit-data-value" colspan="2">
								...
								<BZ:input prefix="FE_" field="FEMALE_PUNISHMENT_EN" id="FE_FEMALE_PUNISHMENT_EN" defaultValue="" type="textarea" maxlength="1000" style="display:none;width:70%"/>
							</td>
						</tr>
						<tr>
							...
							<td class="edit-data-value" colspan="2">
								...
								<BZ:input prefix="FE_" field="MALE_ILLEGALACT_EN" id="FE_MALE_ILLEGALACT_EN" defaultValue="" type="textarea" maxlength="500" style="display:none;width:70%"/>
							</td>
							<td class="edit-data-value" colspan="2">
								...
								<BZ:input prefix="FE_" field="FEMALE_ILLEGALACT_EN" id="FE_FEMALE_ILLEGALACT_EN" defaultValue="" type="textarea" maxlength="500" style="display:none;width:70%"/>
							</td>
						</tr>
						<tr>
							<td class="edit-data-title">宗教信仰</td>
							<td class="edit-data-value" colspan="2">
								<BZ:input prefix="FE_" field="MALE_RELIGION_EN" id="FE_MALE_RELIGION_EN"  defaultValue="" maxlength="500" size="36"/>
							</td>
							<td class="edit-data-value" colspan="2">
								<BZ:input prefix="FE_" field="FEMALE_RELIGION_EN" id="FE_FEMALE_RELIGION_EN"  defaultValue="" maxlength="500" size="36"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="edit-data-value" colspan="4">
								<BZ:input prefix="FE_" field="CHILD_CONDITION_EN" id="FE_CHILD_CONDITION_EN" defaultValue="" type="textarea" maxlength="1000" style="width:80%"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="edit-data-value" colspan="4">
								<BZ:input prefix="FE_" field="ADOPT_REQUEST_EN" id="FE_ADOPT_REQUEST_EN" defaultValue="" type="textarea" maxlength="1000" style="width:80%"/>
							</td>
						</tr>						
					</table>
					...
					<table class="specialtable">
						...
						<tr>
							...
							<td class="edit-data-value" colspan="3">
								<BZ:input prefix="FE_" field="IS_FAMILY_OTHERS_EN" id="FE_IS_FAMILY_OTHERS_EN" type="textarea" defaultValue="" maxlength="500" style="width:70%"/>
							</td>
						</tr>
						<tr>
							<td class="edit-data-title">家庭需说明的其他事项</td>
							<td class="edit-data-value" colspan="5">
								<BZ:input prefix="FE_" field="REMARK_EN" id="FE_REMARK_EN" type="textarea" defaultValue="" maxlength="1000" style="width:80%"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="6">
							<IFRAME ID="frmUpload1" SRC="<%=path%>/common/batchattmaintain.action?bigType=AF&packID=<%=AttConstants.AF_PARENTS%>&packageID=<BZ:dataValue field="PACKAGE_ID" onlyValue="true"/>" frameborder=0 width="100%" ></IFRAME> 
							</td>
						</tr>
						<script>

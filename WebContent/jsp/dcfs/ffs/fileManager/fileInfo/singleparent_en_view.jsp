<%
/**   
 * @Title: singleparent_en_view.jsp
 * @Description:  单亲收养_英文_查看
 * @author wangz   
 * @date 2014-10-29
 * @version V1.0   
 */
			...
			<td>
				...
				<table class="specialtable">
					...
					<tr>
						...
						<td class="edit-data-value">
						<%if("1".equals(ADOPTER_SEX)){%>
						<BZ:dataValue type="String" field="MALE_JOB_EN" defaultValue="" onlyValue="true"/>
						<%}else{%>
						<BZ:dataValue type="String" field="FEMALE_JOB_EN" defaultValue="" onlyValue="true"/>
						<%}%>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="edit-data-value" colspan="4"><BZ:dataValue field="CHILD_CONDITION_EN" defaultValue="" onlyValue="true"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="edit-data-value" colspan="4"><BZ:dataValue field="ADOPT_REQUEST_EN" defaultValue="" onlyValue="true"/>
						</td>
					</tr>
				</table>
				<table class="specialtable">
					...
					<tr>
						...
						<td class="edit-data-value" colspan="3"><BZ:dataValue field="IS_FAMILY_OTHERS_EN" defaultValue="" onlyValue="true"/>
						</td>
					</tr>
					<tr>
						<td class="edit-data-title">家庭需说明的其他事项</td>
						<td class="edit-data-value" colspan="5"><BZ:dataValue field="REMARK_EN" defaultValue="" onlyValue="true"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="6">
						<IFRAME ID="frmUpload" SRC="<%=path%>/common/batchattview.action?bigType=AF&packID=<%=AttConstants.AF_SIGNALPARENT%>&packageID=<BZ:dataValue field="PACKAGE_ID" onlyValue="true"/>" frameborder=0 width="100%" height="100%"></IFRAME> 
						</td>
					</tr>
				</table>
			</td>

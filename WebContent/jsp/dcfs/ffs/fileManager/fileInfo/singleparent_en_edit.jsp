<%
/**   
 * @Title: singleparent_en_edit.jsp
 * @Description:  单亲收养—原文-编辑
 * @author wangz   
 * @date 2014-10-29
 * @version V1.0   
 */
...
<BZ:body property="data" codeNames="WJLX;SYLX;GJ;ADOPTER_EDU;ADOPTER_HEALTH;HBBZ;ADOPTER_HEART_REPORT;ADOPTER_CHILDREN_ABOVE;ADOPTER_ADOPT_MOTIVATION;ADOPTER_CHILDREN_HEALTH;ADOPTER_CHILDREN_SEX;ADOPTER_MARRYCOND">
	...
	<script type="text/javascript">
		...
		function _setMale_health(p){
			...
			if("2"== p){
				$("#tb_dqsy_cn_MALE_HEALTH_CONTENT_EN").show();
				//$("#tb_dqsy_en_MALE_HEALTH_CONTENT_EN").show();
			}else{
				$("#tb_dqsy_cn_MALE_HEALTH_CONTENT_EN").hide();
	...
	function _setMALE_PUNISHMENT_FLAG(f){
		...
		if(f == "1"){
			...
			$("#tb_dqsy_cn_MALE_PUNISHMENT_EN").show();
			$("#tb_dqsy_cn_MALE_PUNISHMENT_EN").val(MALE_PUNISHMENT_EN);
			...
			$("#tb_dqsy_cn_MALE_PUNISHMENT_EN").hide();
	...
	function _setMALE_ILLEGALACT_FLAG(f){
		...
		if(f == "1"){
			...
			$("#tb_dqsy_cn_MALE_ILLEGALACT_EN").show();
			$("#tb_dqsy_cn_MALE_ILLEGALACT_EN").val(MALE_ILLEGALACT_EN);
			...
			$("#tb_dqsy_cn_MALE_ILLEGALACT_EN").hide();
				...
				<td>
					...
					<table class="specialtable">                          	
						...
						<tr>
							...
							<td class="edit-data-value">
								<BZ:input field="MALE_JOB_EN" type="String" formTitle="收养人职业" defaultValue=""  id="tb_dqsy_cn_MALE_JOB_EN" size="30" onchange="_chgValue(this,-1,'MALE_JOB_EN')"/>
							</td>
						</tr>
						<tr>
							...
							<td class="edit-data-value" colspan="2">		   
								<textarea name="FE_MALE_HEALTH_CONTENT_EN" id="tb_dqsy_cn_MALE_HEALTH_CONTENT_EN" maxlength="1000" style="display:none;width:90%" onchange="_chgValue(this,-1,'MALE_HEALTH_CONTENT_EN')"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="edit-data-value" colspan="3">
								<BZ:input field="MALE_PUNISHMENT_EN" id="tb_dqsy_cn_MALE_PUNISHMENT_EN" formTitle="" defaultValue="" type="textarea" maxlength="1000" style="display:none;width:70%" onchange="_chgValue(this,-1,'MALE_PUNISHMENT_EN')"/>
							</td>
						</tr>
						<tr>
							...
							<td class="edit-data-value" colspan="3">
								<BZ:input field="MALE_ILLEGALACT_EN" id="tb_dqsy_cn_MALE_ILLEGALACT_EN" formTitle="" defaultValue="" type="textarea" maxlength="500" style="display:none;width:70%" onchange="_chgValue(this,-1,'MALE_ILLEGALACT_EN')"/>
							</td>
						</tr>
						<tr>
							<td class="edit-data-title">宗教信仰</td>
							<td class="edit-data-value">
								<BZ:input field="MALE_RELIGION_EN" id="tb_dqsy_cn_MALE_RELIGION_EN" formTitle="" defaultValue="" maxlength="500" size="30" onchange="_chgValue(this,-1,'MALE_RELIGION_EN')"/>
							</td>
						...
						<tr>
							...
							<td class="edit-data-value" colspan="4">
								<BZ:input field="CHILD_CONDITION_EN" id="tb_dqsy_cn_CHILD_CONDITION_EN" formTitle="" defaultValue="" type="textarea" notnull="" maxlength="1000" style="width:80%" onchange="_chgValue(this,-1,'CHILD_CONDITION_EN')"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="edit-data-value" colspan="4">
								<BZ:input field="ADOPT_REQUEST_EN" id="tb_dqsy_cn_ADOPT_REQUEST_EN" formTitle="" defaultValue="" type="textarea" maxlength="1000" style="width:80%" onchange="_chgValue(this,-1,'ADOPT_REQUEST_EN')"/>
							</td>
						</tr>
					</table>
					<table class="specialtable">
						...
						<tr>
							...
							<td class="edit-data-value" colspan="3">
								<BZ:input field="IS_FAMILY_OTHERS_EN" id="tb_dqsy_cn_IS_FAMILY_OTHERS_EN" type="textarea" formTitle="" defaultValue="" maxlength="500" style="width:70%" onchange="_chgValue(this,-1,'IS_FAMILY_OTHERS_EN')"/>
							</td>
						</tr>
						<tr>
							<td class="edit-data-title">家庭需说明的其他事项</td>
							<td class="edit-data-value" colspan="5">
								<BZ:input field="REMARK_EN" id="tb_dqsy_cn_REMARK_EN" type="textarea" formTitle="" defaultValue="" maxlength="1000" style="width:80%" onchange="_chgValue(this,-1,'REMARK_EN')"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="6">
							<IFRAME ID="frmUpload" SRC="<%=path%>/common/batchattmaintain.action?bigType=AF&packID=<%=AttConstants.AF_SIGNALPARENT%>&packageID=<BZ:dataValue field="PACKAGE_ID" onlyValue="true"/>" frameborder=0 width="100%" height="100%"></IFRAME> 
							</td>
						</tr>
					</table>
				</td>

...
<script type="text/javascript">
  ...
  */
  function search(){
     document.srcForm.action=path+"transferManager/MannualChildMatchinfo.action";
...
<BZ:body property="data" codeNames="GJSY;WJLX;ETXB;PROVINCE;CHILD_TYPE;SYS_GJSY_CN;">
	<BZ:form name="srcForm" method="post" action="/transferManager/MannualChildMatchinfo.action">
			...
			<tr>
				...
				<table>
					<tr>
						...
						<td class="bz-search-title" style="width: 8%">文件编号</td>
						<td style="width: 40%">
					...
					<tr>
						...
						<td>
							<BZ:select prefix="S_" id="S_FILE_TYPE" field="FILE_TYPE" isCode="true" codeName="WJLX" formTitle="文件类型" defaultValue="">
				              <BZ:option value="">--请选择--</BZ:option>
			                </BZ:select>
						</td>

...
<BZ:html>
 ...
 //显示查询条件
  ...
  function search(){
     document.srcForm.action=path+"transferManager/detailViewChildMatchinfo.action";
...
<BZ:body property="data" codeNames="GJSY;WJLX;ETXB;PROVINCE;CHILD_TYPE;JJMXZT;JSMXZT;SYS_GJSY_CN;">
     <BZ:form name="srcForm" method="post" action="transferManager/detailViewChildMatchinfo.action">
	...
	<div class="table-row" id="searchDiv" style="display: none">
		<table cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
					<BZ:input prefix="S_" field="FILE_NO" id="S_FILE_NO" defaultValue="" restriction="hasSpecialChar" maxlength="50" />
				</td>
			</tr> 
			<tr>
				<td class="bz-search-title">文件类型</td>
				<td>
					<BZ:select prefix="S_" id="S_FILE_TYPE" field="FILE_TYPE" isCode="true" codeName="WJLX" width="148px" formTitle="文件类型" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
				</td>
				<td class="bz-search-title">省份</td>
				<td>
					<BZ:select prefix="S_" id="S_PROVINCE_ID" field="PROVINCE_ID" onchange="selectWelfare(this)" width="148px" isCode="true"  codeName="PROVINCE" formTitle="省份" defaultValue="">
	 	                <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
				</td>
				<td class="bz-search-title">福利院</td>
				<td>
				    <BZ:select prefix="S_" id="S_WELFARE_ID" field="WELFARE_ID" formTitle="福利院" defaultValue="" width="148px">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
				</td>
			</tr>
			<tr>
				<td class="bz-search-title">儿童编号</td>
				<td>
				...
				<td>
					<BZ:select prefix="S_" id="S_SEX" field="SEX" isCode="true" codeName="ETXB" width="148px" formTitle="性别" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
				</td>
			</tr> 
			<tr>						
				...
				<td>
					<BZ:select prefix="S_" id="S_CHILD_TYPE" field="CHILD_TYPE" isCode="true" codeName="CHILD_TYPE" width="148px" formTitle="儿童类型" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
				</td>
				<td class="bz-search-title">特别关注</td>
				<td>
					<BZ:select prefix="S_" id="S_SPECIAL_FOCUS" field="SPECIAL_FOCUS" width="148px" formTitle="特别关注" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
			...
			<tr>
				...
				<td>
					...
					<BZ:select prefix="S_" id="S_TRANSFER_STATE" field="TRANSFER_STATE" isCode="true" codeName="JJMXZT" width="148px" formTitle="移交状态" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
						
					<%} else if("2".equals(OPER_TYPE)){ %>
					<BZ:select prefix="S_" id="S_TRANSFER_STATE" field="TRANSFER_STATE" isCode="true" codeName="JSMXZT" width="148px" formTitle="移交状态" defaultValue="">
		              <BZ:option value="">--请选择--</BZ:option>
	                </BZ:select>
					<%} %>
				</td>

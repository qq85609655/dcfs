...
<BZ:body property="transferFile_print_data" codeNames="WJLX;GJSY;SYZZ;TWCZFS_ALL;TWLX">
...
onlyValue="true" />
										...
										<td><BZ:data field="NAME_CN" defaultValue=""
												onlyValue="true" /></td>
										<%} %>
										<td><BZ:data field="APPLE_TYPE" defaultValue="" codeName="TWLX"
												onlyValue="true" /></td>
										<td><BZ:data field="HANDLE_TYPE" defaultValue="" codeName="TWCZFS_ALL"
													 onlyValue="true" /></td>
										<td><BZ:data field="RETREAT_DATE" defaultValue="" type="Date"
													 onlyValue="true" /></td>
									</tr>
								</BZ:for>

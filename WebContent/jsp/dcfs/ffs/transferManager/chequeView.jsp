...
<BZ:html>
 ...
 //显示查询条件
  ...
  function search(){
     document.srcForm.action=path+"transferManager/detailViewCheque.action";
...
<BZ:body property="data" codeNames="JJMXZT;WJLX;GJSY;JSMXZT;JFFS;SYS_GJSY_CN;">
     <BZ:form name="srcForm" method="post" action="transferManager/detailViewCheque.action">
	...
	<div class="table-row" id="searchDiv" style="display: none">
		<table cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td>	
									<BZ:input prefix="S_" field="PAID_NO" id="S_PAID_NO" defaultValue="" formTitle="缴费编号" restriction="hasSpecialChar" maxlength="256"/>								
							</td>
						  </tr>
						  <tr>
							<td class="bz-search-title">票号</td>
							<td>
										<BZ:input prefix="S_" field="BILL_NO" id="S_BILL_NO" defaultValue="" formTitle="票号" restriction="hasSpecialChar" maxlength="256"/>
										</td>
							<td class="bz-search-title">票面金额</td>
							<td>
										<BZ:input prefix="S_" field="PAR_VALUE_START" id="S_PAR_VALUE_START" defaultValue="" formTitle="票面金额" restriction="hasSpecialChar" maxlength="256"/>~
										<BZ:input prefix="S_" field="PAR_VALUE_END" id="S_PAR_VALUE_END" defaultValue="" formTitle="票面金额" restriction="hasSpecialChar" maxlength="256"/>
										</td>
						  ...
						  <tr>
						  	...
						  	<td>
						  	<BZ:select prefix="S_" field="PAID_WAY" formTitle="缴费方式" isCode="true" codeName="JFFS" width="148px" defaultValue="" id="S_PAID_WAY">
									<BZ:option value="">--请选择--</BZ:option>
								</BZ:select>
							</td>
						  </tr>

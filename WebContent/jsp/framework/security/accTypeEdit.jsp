...
<script type="text/javascript" language="javascript">
	function tijiao()
	{
		...
		document.srcForm.action=path+"accType/accTypeModify.action";
...
<tr>
<td></td>
<td width="5%">账号类型编码</td>
<td><BZ:input field="TYPE_CODE" type="String" notnull="请输入账号类型编码" formTitle="账号类型编码" prefix="P_" defaultValue="" disabled="true"/></td>
<td ></td>
</tr>
<tr>
  <td></td>
...
<td></td>
<td>备注</td>
<td><textarea rows="5" cols="100" name="P_MEMO"><%=accData.getString("MEMO","") %></textarea></td>
<td></td>
</tr>
<!--  
<tr>
<td></td>
<td>扩展属性元数据</td>
<td colspan="3"><textarea rows="5" cols="100" name="P_EXT_METADATA"><%=accData.getString("EXT_METADATA","") %></textarea></td>
<td>
</td>
</tr>
<tr>
...
<td>扩展属性值</td>
<td colspan="3">
    <textarea rows="5" cols="100" name="P_TYPE_EXT_VALUES"><%=accData.getString("TYPE_EXT_VALUES","") %></textarea>
</td>
<td></td>
</tr>
-->

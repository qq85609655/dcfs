...
<BZ:script isList="true" isDate="true"/>
	...
	function search() {
		document.srcForm.action=path+"audit/findAdminAction.action";
	...
	function _export()
	{
		if(confirm('确认要导出为Excel文件吗?')){
			document.srcForm.action=path+"audit/exportAdminExcel.action";
			document.srcForm.submit();
			document.srcForm.action=path+"audit/findAdminAction.action";
		}
	}
...
<BZ:form name="srcForm" method="post" action="audit/findAdminAction.action">

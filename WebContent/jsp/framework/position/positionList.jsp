...
<BZ:script isList="true"  />
  ...
  function add(){
	  document.srcForm.action=path+"position/positionToAdd.action";
	  document.srcForm.submit();
  }
  function _update(){
   var sfdj=0;
  ...
  if(sfdj!="1"){
	  ...
	  document.srcForm.action=path+"position/positionDetailed.action?ID="+ID+"&jsp=modify";
	  document.srcForm.submit();
  }
  }
  ...
  document.srcForm.action=path+"position/positionDetailed.action?ID="+ID+"&jsp=look";
  document.srcForm.submit();
  }
  }
  function _delete(){
  ...
  document.srcForm.action=path+"position/positionDelete.action";
  document.srcForm.submit();
  }else{
  return;
  }
...
<BZ:form name="srcForm" method="post" action="position/positionList.action">
...
<td width="10%">职务代码：</td>
<td width="20%"><BZ:input field="POST_CODE" type="String" prefix="p_" defaultValue=""/></td>
<td width="10%"></td>
<td width="20%"></td>
...
<BZ:th name="职务代码" sortType="string" width="25%" sortplan="jsp"/>
<BZ:th name="职务名称" sortType="string" width="25%" sortplan="jsp"/>
<BZ:th name="职务说明" sortType="string" width="25%" sortplan="jsp"/>
<BZ:th name="排序号" sortType="string" width="15%" sortplan="jsp"/>
</BZ:thead>
<BZ:tbody>
<BZ:for property="dataList" fordata="fordata">
<tr>
<td tdvalue="<BZ:data field="ID" onlyValue="true"/>"><BZ:i></BZ:i></td>
<td><BZ:data field="POST_CODE" defaultValue=""/></td>

...
<script type="text/javascript">
	...
	function tijiao()
	{
		...
		if(sfdj=="0"){
			...
			//roleId=0是角色树的根节点，不允许用户以此保留字符作为[角色ID]。
			if(roleId.value=='0'){
				alert('[角色ID]的值不允许为0！请重新输入！');
				roleId.focus();
				return;
			}
			if(!confirm('确认要分配吗?')){
...
<BZ:form name="srcForm" method="post" token="roleAddNew">
<BZ:frameDiv  property="clueTo" className="kuangjia">

<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
<tr>
<td valign="top" style="background-color:#e9f2fd;width:60%"><div  >
...
<td>角色ID</td>
<td colspan="4">
<BZ:input field="ROLE_ID" id="ROLE_ID" restriction="wordchar" defaultValue="" formTitle="角色ID" prefix="Role_" notnull="请输入角色ID"/>
</td>
</tr>
<tr>
<td width="5%"></td>
...
<td>所属组织</td>
<td colspan="4">
<BZ:input  id="Role_ORGAN_ID" prefix="Role_" field="ORGAN_ID" type="helper" helperCode="SYS_ORGAN" helperTitle="选择部门" saveShowField="false" showParent="false" showField="ORGAN_SHOW" treeType="0" />
...
<table border="0" cellpadding="0" cellspacing="0" class="operation" width="100%">
<tr>

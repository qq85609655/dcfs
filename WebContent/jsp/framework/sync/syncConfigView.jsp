...
<td width="200px">
	可选事件类型<br>
	<select id="SOURCE_EVENT_TYPE" style="width: 200px" name="SOURCE_EVENT_TYPE" size="14" multiple="multiple" disabled>
...
<td valign="middle" width="50px">
	<input type="button" value="&gt;" style="width: 50px" onclick="add(document.getElementById('SOURCE_EVENT_TYPE'),document.getElementById('P_EVENT_TYPE'))" disabled/><br />
	<input type="button" value="&gt;&gt;" style="width: 50px" onclick="addAll(document.getElementById('SOURCE_EVENT_TYPE'),document.getElementById('P_EVENT_TYPE'))" disabled/><br />
	<input type="button" value="&lt;&lt;" style="width: 50px" onclick="addAll(document.getElementById('P_EVENT_TYPE'),document.getElementById('SOURCE_EVENT_TYPE'))" disabled/><br />
    <input type="button" value="&lt;" style="width: 50px" onclick="back(document.getElementById('P_EVENT_TYPE'),document.getElementById('SOURCE_EVENT_TYPE'))" disabled/><br />
</td>
<td>
	已选事件类型<br>
	<select style="width: 200px" id="P_EVENT_TYPE" name="P_EVENT_TYPE" size="14" multiple="multiple" disabled>
	</select>
</td>
</tr>
</table>

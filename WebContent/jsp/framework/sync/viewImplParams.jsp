...
<div class="heading">实现类参数</div>
<table id="mtable" width="100%"  cellspacing="0" >
	<tr id="tr1" >
			<td style="padding-left: 5px ;width:30%">参数名称：<BZ:input field="PARAM_NAME" prefix="P_" type="String" notnull="请输入参数名称" formTitle="参数名称" onkeyup="strFilter(this)" defaultValue="" disabled="true"/></td>
			<td style="padding-left: 5px ;width:70%">参数值：<BZ:input field="PARAM_VALUE" prefix="P_" type="String" notnull="请输入参数值" formTitle="参数值" onkeyup="strFilter(this)" defaultValue="" size="50" disabled="true"/></td>
	</tr>
</table>

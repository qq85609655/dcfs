...
<td></td>
<td>用户同步实现类</td>
<td><BZ:input field="USER_IMPL" type="String" notnull="请输入用户同步实现类" formTitle="用户同步实现类"  prefix="P_" defaultValue="" size="50"/>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="gotoEditParam('userSync')">编辑参数</a></td>
</tr>
<tr>
<td></td>
<td>组织同步实现类</td>
<td><BZ:input field="ORG_IMPL" type="String" notnull="请输入组织同步实现类" formTitle="组织同步实现类" prefix="P_" defaultValue="" size="50"/>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="gotoEditParam('orgSync')">编辑参数</a></td>
</tr>
<tr>
<td></td>
<td>状态</td>

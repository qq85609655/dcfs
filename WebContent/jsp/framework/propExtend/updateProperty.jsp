...
if("true".equals(view)){
	tableTitle="查看"+tableTitle;
}else{
	tableTitle="修改"+tableTitle;
}
%>
<BZ:html>
<BZ:head>
...
<BZ:body property="data" >
	<BZ:form name="srcForm" method="post">
		...
		<table border="0" width="100%" class="contenttable" align="center">
			...
			<tr align="left">
				<td>*排序号：</td>
				<td><BZ:input field="SEQ_NUM" type="String" restriction="int" prefix="Prop_" notnull="请输入排序号" formTitle="排序号" defaultValue=""/>

...
<BZ:head>
	...
	document.srcForm.action=path+"doneinfo/send.action";
 	...
 	document.srcForm.action = path+"doneinfo/search.action";
	}
...
<BZ:body onload="_onload();">
	<div class="mainShort">
		...
		<!--bg end-->
		<div class="mainD">
		<BZ:form name="srcForm" method="post" action="doneinfo/search.action">
			...
			<div class="xx_T">
					...
					<table border="0" cellspacing="0" cellpadding="0" width="100%">
						...
						<tr>
							...
							<td width="295" class="style2">
								<BZ:input field="START_TIME" prefix="Send_" defaultValue=""
									type="date" property="data" id="Send_START_TIME" dateExtend="maxDate:'#F{$dp.$D(\\'Send_END_TIME\\')}',readOnly:true"/>
								-
								<BZ:input field="END_TIME" prefix="Send_" defaultValue=""
									type="date" property="data" id="Send_END_TIME" dateExtend="minDate:'#F{$dp.$D(\\'Send_START_TIME\\')}',readOnly:true"/>
							</td>
							<td align="right" bgcolor="#F5F5F5" width="108">
								接收者：
							</td>
						...
						<tr>
							...
							<td>
								<BZ:input className="text_xx3" field="SENDER" prefix="Send_" defaultValue="" property="data"/>
							</td>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								...
								<td colspan="7" class="style4" id="td<%=i%>">
									<%=info.getString(Sms_Send.CONTENT)!=null?info.getString(Sms_Send.CONTENT):""%></td>
							</tr>

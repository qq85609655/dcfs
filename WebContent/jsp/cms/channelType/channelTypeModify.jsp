...
$(document).ready(function(){
	...
	document.srcForm.action=path+"channel/ChannelType!modify.action";
...
<div class="kuangjia">
<div class="heading">修改栏目类型</div>
<BZ:input type="hidden" field="ID" prefix="ChannelType_"/>
...
<td></td>
<td>说明</td>
<td colspan="4"><textarea rows="6" style="width:80%" name="ChannelType_MEMO"><%=data.getString("MEMO")!=null?data.getString("MEMO"):"" %></textarea></td>
</tr>

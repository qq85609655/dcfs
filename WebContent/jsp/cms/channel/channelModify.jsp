...
$(document).ready(function(){
	...
	document.srcForm.action=path+"channel/Channel!modify.action";
...
<BZ:body property="data" onload="_changeOptionItems(document.getElementById('CHANNEL_STYLE').value);">
<BZ:form name="srcForm" method="post">
<div class="kuangjia">
<div class="heading">修改栏目</div>
<!-- 当前修改的组织机构ID -->
<BZ:input field="ID" type="hidden" prefix="Channel_" defaultValue=""/>
<!-- 父组织机构ID -->
...
<td width="7%">是否审核</td>
<td width="20%">
	<input type="radio" name="Channel_IS_AUTH" value="1" <%="1".equals(data.getString(Channel.IS_AUTH))?"checked='checked'":"" %>>是
	<input type="radio" name="Channel_IS_AUTH" value="2" <%="2".equals(data.getString(Channel.IS_AUTH))?"checked='checked'":"" %>>否
</td>
<!-- 
<td width="8%">栏目类型</td>
<td width="20%">
...
<td>栏目样式</td>
<td colspan="4">
	<BZ:select id="CHANNEL_STYLE" field="CHANNEL_STYLE" prefix="Channel_" formTitle="" onchange="_changeOptionItems(this.value);"  className="rs-edit-select">
...
<td colspan="4">
	<up:uploadBody 
		...
		packageId="<%=data.getString(Channel.CHANNEL_ICON) %>"
...
<tr>
<td>说明</td>
<td colspan="4"><textarea rows="6" style="width:80%" name="Channel_MEMO"><%=data.getString("MEMO")!=null?data.getString("MEMO"):"" %></textarea></td>
</tr>

...
<div class="main"> 
    ...
    <div class="mainB"> 
        	...
        	<div class="mainB_Lt" id="daohang"> 
            	...
            	<div class="ps" id="<%=channel.getString(Channel.ID) %>" <%="0".equals(channel.getString("i"))?"style='display:block;'":"style='display:none;'" %>>
                	...
                	<%
	            		...
	            		if(cn > 0){
                	%>
                    <div class="f" cid="<%=child.getString(Channel.ID) %>" onclick="k('<%=child.getString(Channel.ID) %>',this)"><cms:channelTitle onclick="_clickType(this);" runChannelStyle="true" titleLength="8" link="true" href="channel/Channel!channelDetailOutside.action" params="PARENT_ID" paramValues="<%=parent.getString(Channel.ID) %>" target="_self"/></div>
                    <div class="ps bgnone" id="<%=child.getString(Channel.ID) %>">
                        ...
                        <div class="s">
                        	<cms:channelTitle onclick="_clickType(this);" runChannelStyle="true" titleLength="8" link="true" href="channel/Channel!channelDetailOutside.action" params="PARENT_ID" paramValues="<%=parent.getString(Channel.ID) %>" target="_self"/>
                        </div>
                        </cms:channelList>
                    </div>
                    <%
            	...
            	<div class="fblod" onclick="_clickMenu(this);">
            		<cms:channelTitle onclick="_clickType(this);" runChannelStyle="true" titleLength="10" link="true" href="channel/Channel!channelDetailOutside.action" params="PARENT_ID" paramValues="<%=parent.getString(Channel.ID) %>" target="_self"/>
            	</div>
            	<%
            		}
            	%>
        ...
        <div class="mainB_R" id="main_content" style="display:block"> 
            ...
            <div class="mainB_Rf"> 
            <cms:form id="channelList" action="channel/Channel!channelDetailOutside.action">
            	<div class="list_bjtj"> 
					...
					<li>		
						<a href="<BZ:url/>/article/Article!detailArt.action?ID=<%=art.getString(Article.ID) %>" target="_blank" title='<cms:infoTitle />'>
							...
							<cms:infoNew src='<%=path + "/jsp/cms/images/new.gif" %>' height="9px" width="22px"/>

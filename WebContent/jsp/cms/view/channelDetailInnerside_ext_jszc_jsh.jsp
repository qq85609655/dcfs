	    ...
	    <div class="mainL">
             <div class="mainLt">
                 ...
                 <div class="mainB_Lt" id="daohang" style="float:left;">
                	 ...
                	 <!-- 栏目循环结束 -->
                	 <!-- 模板库开始 -->
				<div class="fblod" cid="cybbmb" onclick="_clickMenu(this);;w('cybbmb',this)">常用报告模板库</div>
                	 	<%
                	    	if(commTplTypeList.size()>0){
                	    %>
	                	
	                	<div class="ps" id="cybbmb" style='display:none;'>
	                	<%
	                			for(int i=0;i<commTplTypeList.size();i++){
	                	    		Data commTplType = commTplTypeList.getData(i);
	                	%>
				            <div onclick="_selMe(this);" class="o">
                        ...
                        %>
	                	<div class="fblod" cid="myTpl" onclick="_clickMenu(this);;w('myTpl',this)">我的模板</div>

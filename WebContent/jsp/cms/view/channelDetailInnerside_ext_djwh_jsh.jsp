                 ...
                 <div class="mainB_Lt" id="daohang" style="float:left;">
                     <div><img src="<BZ:resourcePath/>/nw/images/part_bg4.gif" /></div>
		                ...
		                <%
		            		...
		            		if(cNum > 0){
		            	%>
		            	<div class="fblod" cid="<%=channel.getString(Channel.ID) %>" onclick="w('<%=channel.getString(Channel.ID) %>',this)" title="<cms:channelTitle/>"><cms:channelTitle titleLength="10" /></div>
		            	<div class="ps" id="<%=channel.getString(Channel.ID) %>" style='display:none;'>
		                	...
		                	<%
			            		...
			            		if(cn > 0){
		                	%>
		                    <div class="f" onclick="k('<%=child.getString(Channel.ID) %>')"><cms:channelTitle titleLength="8" link="true" href="channel/Channel!channelDetailInnersideExt.action" params="PARENT_ID;sign" paramValues='<%=parent.getString(Channel.ID)+";ext_djwh" %>' target="_self"/></div>
		                    <div class="ps bgnone" id="<%=child.getString(Channel.ID) %>">
		                        ...
		                        <div class="o">
		                        	<cms:channelTitle titleLength="8" link="true" href="channel/Channel!channelDetailInnersideExt.action" params="PARENT_ID;sign" paramValues='<%=parent.getString(Channel.ID)+";ext_djwh" %>' target="_self"/>
		                        </div>
		                        </cms:channelList>
		                    </div>
		                    <%
		            	...
		            	<div class="fblod" onclick="_clickMenu(this)">
		            		<cms:channelTitle titleLength="10" link="true" href="channel/Channel!channelDetailInnersideExt.action" params="PARENT_ID;sign" paramValues='<%=parent.getString(Channel.ID)+";ext_djwh" %>' target="_self"/>
		            	</div>
		            	<%
		            		}
		            	%>

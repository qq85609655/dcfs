// 定义swfupload组件
function initUpload(id,root,attTypeCode,packageId,uuidForPackageId,requestPrefix,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,autoUpload,titleLength,selectTitle,appendOnclick,hiddenSelectTitle,buttonImage,successMess,unit,personalParams) {
	...
	//初始化swfupload组件
	var swfu = new SWFUpload(settings,id,requestPrefix,root,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,autoUpload,titleLength,appendOnclick,successMess,personalParams);
	...
	$.ajax({
		...
		success: function(rs){  
			...
			$.each(arr,function(i,n){
				//填充到上传队列
				initUploadedFiles(root,id,n.id,n.fileName,n.code,n.packageId,requestPrefix,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,titleLength,successMess,n.createTime,personalParams);
			});
		}
	});
...
function initUploadList(id,root,attTypeCode,packageId,uuidForPackageId,requestPrefix,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,autoUpload,titleLength,appendOnclick,listCellStyle,personalParams) {
	...
	//初始化swfupload组件
	var swfu = new SWFUpload(settings,id,requestPrefix,root,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,autoUpload,titleLength,appendOnclick,"",personalParams);
	...
	$.ajax({
		...
		success: function(rs){  
			...
			$.each(arr,function(i,n){
				//填充到上传队列
				initUploadedFilesList(root,id,n.id,n.fileName,n.code,n.packageId,requestPrefix,firstColWidth,secondColWidth,thirdColWidth,forthColWidth,titleLength,listCellStyle,n.createTime,personalParams);
			});
		}
	});
...
//开始上传
function startUploadFile(upComId){
	//判断是否存在要上传的文件

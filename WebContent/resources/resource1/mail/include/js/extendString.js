...
String.prototype.isNumberLength= function(length){
	return (this.isInt() || this.isdLength(length));
}
String.prototype.isdLength = function(length) {
	return /^(?:-?|\+?)\d*\.\d{0,2}$/g.test(this);
}

...
function doSClick() {
	...
	if (targetElement.style.display == "none") {
		imageElement.src = resourcePath+"/images/minus.gif"
		targetElement.style.display = "";
	} else {
		imageElement.src =resourcePath+"/images/plus.gif"
...
function doClick() {
	...
	targetElement = document.all(targetId);
	if (targetElement.style.display == "none") {
		srcElement.src = resourcePath+"/images/minus.gif"
		targetElement.style.display = "";
	} else {
		srcElement.src = resourcePath+"/images/plus.gif"
		targetElement.style.display = "none";
	}
}
